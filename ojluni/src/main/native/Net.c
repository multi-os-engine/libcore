...
static JNINativeMethod gMethods[] = {
  ...
  NATIVE_METHOD(Net, pollingValue, "(Ljava/io/FileDescriptor;)S"),
  NATIVE_METHOD(Net, polloutValue, "(Ljava/io/FileDescriptor;)S"),
  NATIVE_METHOD(Net, pollhupValue, "(Ljava/io/FileDescriptor;)S"),
  NATIVE_METHOD(Net, pollerrValue, "(Ljava/io/FileDescriptor;)S"),
  NATIVE_METHOD(Net, pollnvalValue, "(Ljava/io/FileDescriptor;)S"),
  NATIVE_METHOD(Net, pollconnValue, "(Ljava/io/FileDescriptor;)S"),
};

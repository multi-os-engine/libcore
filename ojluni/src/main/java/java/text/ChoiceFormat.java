...
public class ChoiceFormat extends NumberFormat {
     ...
     *
     * @return a copy of the double[] array supplied to the constructor or the most recent call to
     ...
     *
     * @return a copy of the String[] array supplied to the constructor or the most recent call to
     * {@link #setChoices(double[], String[])}.
     */

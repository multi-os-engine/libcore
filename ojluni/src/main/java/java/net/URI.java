    ...
    private class Parser {
            ...
            throws URISyntaxException
        {
            ...
            do {
                ...
                //
                // The RFC's don't permit underscores in hostnames, but URI has to because a certain
                ...
                if (q > p) {
                    p = q;
                    q = scan(p, n, L_ALPHANUM | L_DASH | H_UNDERSCORE, H_ALPHANUM | H_DASH | H_UNDERSCORE);
                    if (q > p) {
                        if (charAt(q - 1) == '-')

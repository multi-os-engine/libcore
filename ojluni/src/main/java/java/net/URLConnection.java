 ...
 * </pre></blockquote>
 *
 * Note about {@code fileNameMap}: In versions prior to JDK 1.1.6,
 * field {@code fileNameMap} of {@code URLConnection} was public.
 * In JDK 1.1.6 and later, {@code fileNameMap} is private; accessor

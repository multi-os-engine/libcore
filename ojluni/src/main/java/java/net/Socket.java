...
class Socket implements java.io.Closeable {
     ...
     * specifying the address as {@code {@link java.net.InetAddress#getByName InetAddress.getByName}(null)}.
     ...
     * specifying the address as the AnyLocal address (see {@code {@link java.net.InetAddress#isAnyLocalAddress InetAddress.isAnyLocalAddress}()}).
     * <p>
     * A local port number of {@code zero} will let the system pick up a
     * free port in the {@code bind} operation.</p>
     * <p>
     ...
     *         socket, or {@code null} if it is not bound yet.
     * @see #getLocalAddress()
     * @see #getLocalPort()
     ...
     *
     * @return a {@code boolean} indicating whether or not TCP_NODELAY is enabled.
     * @exception SocketException if there is an error
     * in the underlying protocol, such as a TCP error.
     * @since   JDK1.1
     ...
     *
     * @param on {@code true} to enable OOBINLINE,
     * {@code false} to disable.
     *
     * @exception SocketException if there is an error
     * in the underlying protocol, such as a TCP error.
     ...
     *
     * @return a {@code boolean} indicating whether or not OOBINLINE is enabled.
     * @exception SocketException if there is an error
     * in the underlying protocol, such as a TCP error.
     * @since   1.4
     ...
     * {@code Socket}. The SO_SNDBUF option is used by the platform's
    ...
    /**
     * Get value of the SO_SNDBUF option for this {@code Socket},
     * that is the buffer size used by the platform
     * for output on this {@code Socket}.
     * @return the value of the SO_SNDBUF option for this {@code Socket}.
     *
     * @exception SocketException if there is an error
     * in the underlying protocol, such as a TCP error.
     *
     ...
     * {@code Socket}. The SO_RCVBUF option is used by the platform's
     * networking code as a hint for the size to set
     * the underlying network I/O buffers.
     *
    ...
    /**
     * Gets the value of the SO_RCVBUF option for this {@code Socket},
     * that is the buffer size used by the platform for
     * input on this {@code Socket}.
     *
     * @return the value of the SO_RCVBUF option for this {@code Socket}.
     * @exception SocketException if there is an error
     * in the underlying protocol, such as a TCP error.
     ...
     *
     * @return a {@code boolean} indicating whether or not SO_KEEPALIVE is enabled.
     * @exception SocketException if there is an error
     * in the underlying protocol, such as a TCP error.
     * @since   1.3
     ...
     * <p>
     * Enabling {@code SO_REUSEADDR} prior to binding the socket

...
public final class HttpCookie implements Cloneable {
     ...
     *
     * @param header    a {@code String} specifying the set-cookie header.
   ...
   /**
     ...
     *
     * @param purpose           a {@code String} specifying the comment url
     *                          to display to the user
     *
     * @see #getCommentURL
     *
     ...
     *
     * @return                  a {@code String} containing the comment url,
     *                          or {@code null} if none
     *
     * @see #setCommentURL
     *
     ...
     *
     * @param ports     a {@code String} specify the port list, which is
     ...
     *
     * @return  a {@code String} contains the port list
     *          or {@code null} if none
     * @see #setPortlist
     */
    ...
    /**
     * Returns {@code true} if sending this cookie should be
     * restricted to a secure protocol, or {@code false} if the
     * it can be sent using any protocol.
     *
     * @return          {@code false} if the cookie can be sent over
     *                  any standard protocol; otherwise, {@code true}
     *
     * @see #setSecure
     *
     */
     ...
     *
     * @return                  a {@code String} containing the cookie's
     *                          present value
     *
     * @see #setValue
     *
     ...
     *
     * @return                  {@code true} if the {@code String} is
     *                          a token; {@code false} if it is not
     */

...
/////////////////
    ...
    /**
     * Get the total offset used, the sum of the ZONE_OFFSET and DST_OFFSET fields.
     */
    private int internalOffset() {
        return internalGet(ZONE_OFFSET) + internalGet(DST_OFFSET);
    }
    ...
    private final long getYearOffsetInMillis() {
        ...
        t *= 1000;
        return t + internalGet(MILLISECOND) - internalOffset();
    }

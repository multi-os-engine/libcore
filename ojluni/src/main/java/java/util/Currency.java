...
public final class Currency implements Serializable {
    ...
    private android.icu.util.Currency icuCurrency;
    ...
    public static Set<Currency> getAvailableCurrencies() {
        ...
        Set<Currency> wrappedCurrencies = new HashSet<>();
        for (android.icu.util.Currency icuCurrency : icuAvailableCurrencies) {
            Currency currency = new Currency(icuCurrency);
            synchronized (instances) {
                instances.put(currency.getCurrencyCode(), currency);
            }
            wrappedCurrencies.add(currency);
        }
        return wrappedCurrencies;
    }
    ...
    public String getCurrencyCode() {
        return icuCurrency.getCurrencyCode();
    }
    ...
    private Object readResolve() {
        return android.icu.util.Currency.getInstance(getCurrencyCode());
    }
}

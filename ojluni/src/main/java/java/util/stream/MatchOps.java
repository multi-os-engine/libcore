...
final class MatchOps {
    ...
    public static <T> TerminalOp<T, Boolean> makeRef(Predicate<? super T> predicate,
        ...
        // Android-changed: Work-around jack method reference bug
        return new MatchOp<>(StreamShape.REFERENCE, matchKind, () -> new MatchSink());
    }
    ...
    public static TerminalOp<Integer, Boolean> makeInt(IntPredicate predicate,
        ...
        return new MatchOp<>(StreamShape.INT_VALUE, matchKind, () -> new MatchSink());
    }
    ...
    public static TerminalOp<Long, Boolean> makeLong(LongPredicate predicate,
        ...
        return new MatchOp<>(StreamShape.LONG_VALUE, matchKind, () -> new MatchSink());
    }
    ...
    public static TerminalOp<Double, Boolean> makeDouble(DoublePredicate predicate,
        ...
        return new MatchOp<>(StreamShape.DOUBLE_VALUE, matchKind, () -> new MatchSink());
    }

...
public class Cipher {
    ...
    protected Cipher(CipherSpi cipherSpi,
        ...
        this(cipherSpi, provider, transformation, null);
    }
            ...
            NoSuchPaddingException
    {
        ...
        return getCipher(transformation, p);
    }
    ...
    static final Cipher getCipher(String transformation, Provider provider)
        throws NoSuchAlgorithmException, NoSuchPaddingException {
        ...
        try {
            cipherSpiAndProvider =
                tryCombinations(null, provider, tokenizedTransformation);

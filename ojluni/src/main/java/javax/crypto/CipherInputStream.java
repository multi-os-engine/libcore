...
public class CipherInputStream extends FilterInputStream {
    ...
    private int getMoreData() throws IOException {
        // Android-changed: Did use to create a new object time update(byte[], int, int) or
        // doFinal() was called resulting in the old object being GCed. With doFinal(byte[], int)
        // and update(byte[], int, int, byte[], int), we use already initialized byte array.
        if (done) return -1;
        ...
        // the call, ofinish should be set to 0 as the
        try {
    ...
    protected CipherInputStream(InputStream is) {
        // Android-changed: Ensure consistency with the other constructor.

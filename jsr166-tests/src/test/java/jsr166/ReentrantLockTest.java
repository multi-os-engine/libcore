...
public class ReentrantLockTest extends JSR166TestCase {
    ...
    /* @Ignore */ public void testUnlock_IMSE(boolean fair) {
    ...
    /* @Ignore */ public void testTryLock(boolean fair) {
        PublicReentrantLock lock = new PublicReentrantLock(fair);
    ...
    /* @Ignore */ public void testTryLock_Interruptible(boolean fair) {
        final PublicReentrantLock lock = new PublicReentrantLock(fair);
        lock.lock();
    ...
    /* @Ignore */ public void testTryLockWhenLocked(boolean fair) {
        final PublicReentrantLock lock = new PublicReentrantLock(fair);
        lock.lock();
    ...
    /* @Ignore */ public void testTryLock_Timeout(boolean fair) {
        final PublicReentrantLock lock = new PublicReentrantLock(fair);
        lock.lock();
        Thread t = newStartedThread(new CheckedRunnable() {
            public void realRun() throws InterruptedException {
    ...
    /* @Ignore */ public void testIsLocked(boolean fair) {
        try {
            final ReentrantLock lock = new ReentrantLock(fair);
            assertFalse(lock.isLocked());
            lock.lock();
    ...
    /* @Ignore */ public void testLockInterruptibly(boolean fair) {
        final PublicReentrantLock lock = new PublicReentrantLock(fair);
        try {
            lock.lockInterruptibly();

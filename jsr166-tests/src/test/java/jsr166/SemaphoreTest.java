...
public class SemaphoreTest extends JSR166TestCase {
    ...
    /* @Ignore */ public void testConstructor(boolean fair) {
    ...
    /* @Ignore */ public void testTryAcquireInSameThread(boolean fair) {
    ...
    /* @Ignore */ public void testTryAcquire_timeout(boolean fair) {
    ...
    /* @Ignore */ public void testTryAcquireN_timeout(boolean fair) {
        Semaphore s = new Semaphore(2, fair);
        long startTime = System.nanoTime();
    ...
    /* @Ignore */ public void testInterruptible(boolean fair, final AcquireMethod acquirer) {
    ...
    /* @Ignore */ public void testUninterruptible(boolean fair, final AcquireMethod acquirer) {
        final PublicSemaphore s = new PublicSemaphore(0, fair);
    ...
    /* @Ignore */ public void testDrainPermits(boolean fair) {
        Semaphore s = new Semaphore(0, fair);
        assertEquals(0, s.availablePermits());
    ...
    /* @Ignore */ public void testReleaseIAE(boolean fair) {
    ...
    /* @Ignore */ public void testReducePermitsIAE(boolean fair) {
    ...
    /* @Ignore */ public void testReducePermits(boolean fair) {
        PublicSemaphore s = new PublicSemaphore(10, fair);
        assertEquals(10, s.availablePermits());
        s.reducePermits(0);
        assertEquals(10, s.availablePermits());
    ...
    /* @Ignore */ public void testTryAcquireNInSameThread(boolean fair) {
        Semaphore s = new Semaphore(2, fair);
        assertEquals(2, s.availablePermits());
    ...
    /* @Ignore */ public void testReleaseAcquireSameThread(boolean fair,
    ...
    /* @Ignore */ public void testReleaseAcquireDifferentThreads(boolean fair,
                                                   final AcquireMethod acquirer) {

...
public class SocketChannelTest extends TestCase {
    ...
    public void testBind_ExplicitFreePort() throws Exception {
        // Close a server port so we know it is free.
        InetSocketAddress address = (InetSocketAddress) server1.getLocalSocketAddress();

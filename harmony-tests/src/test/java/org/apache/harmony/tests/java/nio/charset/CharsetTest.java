...
import libcore.java.nio.charset.FakeCharsetProvider;
...
public class CharsetTest extends TestCase {
  ...
  public void testIsSupported_And_ForName_NormalProvider() throws Exception {
    FakeCharsetProvider.setDelegate(new MockCharsetProvider());
    try {
      ...
      FakeCharsetProvider.clearDelegate();
    }
  }
  ...
  public void testForName_DuplicateWithBuiltInCharset() throws Exception {
    FakeCharsetProvider.setDelegate(new MockCharsetProviderASCII());
    try {
  ...
  public void testForName_withProviderWithRecursiveCall() throws Exception {
    FakeCharsetProvider.setDelegate(new MockCharsetProviderWithRecursiveCall());
    try {

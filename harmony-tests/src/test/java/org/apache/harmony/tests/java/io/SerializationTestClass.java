...
public class SerializationTestClass implements java.io.Serializable {
    ...
    public static class TestIntefaces implements java.io.Serializable {
    }

    public static class TestIntefacesA implements A {
    }

    public static class TestIntefacesAB implements A, B {
    }

    public static class TestIntefacesBA implements B, A {
    }

    public static class TestIntefacesC implements C {
    }

    public static class TestIntefacesAC implements A, C {
    }

    public static class TestIntefacesCA implements C, A {
    }

    public static class TestIntefacesABC implements A, B, C {
    }

    public static class TestIntefacesACB implements A, C, B {
    }

    public static class TestIntefacesBAC implements B, A, C {
    }

    public static class TestIntefacesBCA implements B, C, A {
    }

    public static class TestIntefacesCAB implements C, A, B {
    }

    public static class TestIntefacesCBA implements C, B, A {
    }
    ...
    @SuppressWarnings("unused")
    public static class TestMehodPrivate implements java.io.Serializable {
        private void method() {
        }
    }

        ...
        class WriteRunnable implements Runnable {
            ...
            public void run() {
                try {
                    ...
                    try {
                        // The function is specified to throw an IOException
                        // if the reader thread is already dead but....
                        pos.write(1);

                        // ... unlike the RI, the libcore implementation performs thread
                        // liveness checks only when the PipedInputStream buffer is full.
                        pos.write(1);
                        fail();
                    } catch (IOException expected) {
                    }

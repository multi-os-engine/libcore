...
public class FloatTest extends TestCase {
    ...
    public void test_isInfiniteF() {
        ...
        assertTrue("Infinity check failed", Float.isInfinite(Float.POSITIVE_INFINITY)
                ...
                && !(Float.isInfinite(Float.MAX_VALUE))
                && !(Float.isInfinite(Float.MIN_VALUE))
                && !(Float.isInfinite(Float.NaN))
    ...
    public void test_isFiniteF() {
        // Test for method boolean java.lang.Float.isInfinite(float)
        assertTrue("Finity check failed", !Float.isFinite(Float.POSITIVE_INFINITY)
                && !(Float.isFinite(Float.NEGATIVE_INFINITY))
                && (Float.isFinite(Float.MAX_VALUE))
                && (Float.isFinite(Float.MIN_VALUE))

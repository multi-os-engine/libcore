...
public class DecimalFormatTest extends TestCase {
    ...
    public void testSetNan_emptyString() throws Exception {
    ...
    public void testParse_bigDecimal() throws Exception {
    ...
    public void testParse_integerOnly() throws Exception {
    ...
    public void testParse_returnType() {
    ...
    public void testParse_largeBigDecimal() {
        DecimalFormat form = (DecimalFormat) DecimalFormat.getInstance(Locale.US);
        form.setParseIntegerOnly(true);
        form.setParseBigDecimal(true);
    ...
    public void testFormatObject_errorCases() {
        DecimalFormat form = (DecimalFormat) NumberFormat.getInstance(Locale.US);
    ...
    public void testSetPositivePrefix() throws Exception {
        DecimalFormat format = new DecimalFormat();
    ...
    public void testSetPositiveSuffix() throws Exception {
        DecimalFormat format = new DecimalFormat();
    ...
    public void testSetNegativePrefix() throws Exception {
        DecimalFormat format = new DecimalFormat();
    ...
    public void testSetNegativeSuffix() throws Exception {
        DecimalFormat format = new DecimalFormat();
    ...
    public void testApplyPattern_icu2GroupingSizes() {
    ...
    public void testFormatDouble_maximumFractionDigits() {
    ...
    public void testFormatDouble_minimumFractionDigits() {
        DecimalFormat df = new DecimalFormat("###0.##", new DecimalFormatSymbols(Locale.US));
        df.setMinimumFractionDigits(4);
    ...
    public void testFormatDouble_scientificNotationProblemCases() {
    ...
    public void testFormatDouble_withFieldPosition() {
        new Support_DecimalFormat(
                "test_formatDLjava_lang_StringBufferLjava_text_FieldPosition")
                .t_format_with_FieldPosition();
    }

    public void testFormatDouble_scientificNotation() {
        final DecimalFormatSymbols dfs = new DecimalFormatSymbols(Locale.US);
    ...
    public void testFormatDouble_scientificNotationMinusZero() throws Exception {
        final DecimalFormatSymbols dfs = new DecimalFormatSymbols(Locale.US);
    ...
    public void testFormatLong_maximumIntegerDigits() {
    ...
    public void testFormatLong_minimumIntegerDigits() {
        DecimalFormat df = new DecimalFormat("###0.##", new DecimalFormatSymbols(Locale.US));
    ...
    public void testFormatLong_scientificNotation() {
        final DecimalFormatSymbols dfs = new DecimalFormatSymbols(Locale.US);
    ...
    public void testFormatDouble_wideRange() {
        final DecimalFormatSymbols dfs = new DecimalFormatSymbols(Locale.US);
    ...
    public void testFormatDouble_varyingScaleProblemCases() throws Exception {
        final DecimalFormatSymbols dfs = new DecimalFormatSymbols(Locale.US);
        DecimalFormat format = new DecimalFormat("#0.#", dfs);
        format.setMaximumIntegerDigits(400);
        format.setMaximumFractionDigits(400);
    ...
    public void testFormatDouble_varyingScale() throws Exception {
        final DecimalFormatSymbols dfs = new DecimalFormatSymbols(Locale.US);
        DecimalFormat format = new DecimalFormat("#0.#", dfs);
        format.setMaximumIntegerDigits(400);
        format.setMaximumFractionDigits(400);
    ...
    public void testParse_withMultiplier() {
        DecimalFormat format = (DecimalFormat) NumberFormat.getNumberInstance(Locale.ENGLISH);
        Number result;
    ...
    public void testFormatToCharacterIterator_null() {
        try {
    ...
    public void testFormatToCharacterIterator_original() {
        new Support_DecimalFormat(
                "test_formatToCharacterIteratorLjava_lang_Object")
                .t_formatToCharacterIterator();
    }

    public void testFormatToCharacterIterator() throws Exception {
    ...
    public void testFormatToCharacterIterator_veryLarge() throws Exception {
        AttributedCharacterIterator iterator;
        int[] runStarts;
        int[] runLimits;
        String result;
    ...
    public void testFormatToCharacterIterator_roundingUnnecessaryArithmeticException() {
    ...
    public void testFormatDouble_roundingUnnecessaryArithmeticException() {
        DecimalFormat decimalFormat = (DecimalFormat) DecimalFormat.getInstance(Locale.US);
        decimalFormat.setMaximumFractionDigits(0);
        decimalFormat.setRoundingMode(RoundingMode.UNNECESSARY);
    ...
    public void testFormat_roundingUnnecessaryArithmeticException() {
        final DecimalFormatSymbols dfs = new DecimalFormatSymbols(Locale.US);
    ...
    public void testSetRoundingMode_null() {
        DecimalFormat decimalFormat = (DecimalFormat) DecimalFormat.getInstance(Locale.US);
        try {
    ...
    public void testFormat_withRoundingMode() {
        DecimalFormat decimalFormat = (DecimalFormat) DecimalFormat.getInstance(Locale.US);

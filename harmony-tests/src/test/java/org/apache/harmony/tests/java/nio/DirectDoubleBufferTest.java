...
public class DirectDoubleBufferTest extends DoubleBufferTest {
    ...
    public void testJNIAccessByAddress() throws Exception {
        ...
        long byteBufferAddress = NIOAccess.getBasePointer(directByteBuffer);
        long doubleBufferAddress = NIOAccess.getBasePointer(doubleBuffer);

        assertEquals(byteBufferAddress + SizeOf.DOUBLE, doubleBufferAddress);
    }

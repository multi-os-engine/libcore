...
public class DirectIntBufferTest extends IntBufferTest {
    ...
    public void testAddress() throws NoSuchFieldException, IllegalAccessException {
        ...
        Field addressFieldIB  = Buffer.class.getDeclaredField("address");
        addressFieldIB.setAccessible(true);
        long addressIB = (long)addressFieldIB.get(intBuffer);
        ...
        assertEquals(addressDB + 1, addressIB);
    }

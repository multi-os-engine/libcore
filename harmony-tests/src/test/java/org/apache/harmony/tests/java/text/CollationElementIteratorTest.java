...
public class CollationElementIteratorTest extends TestCase {
  ...
  private RuleBasedCollator tradEsColl;

  protected void setUp() {
    coll = (RuleBasedCollator) Collator.getInstance(Locale.US);
    tradEsColl = (RuleBasedCollator) Collator.getInstance(Locale.forLanguageTag("es-u-co-trad"));
  }
  ...
  public void testSetTextString() {
    String text = "caa";
    CollationElementIterator iterator = tradEsColl.getCollationElementIterator(text);
    iterator.setOffset(0);
    assertEquals(0, iterator.getOffset());
    iterator.setOffset(1);

...
public class DirectFloatBufferTest extends FloatBufferTest {
    ...
    public void testAddress() throws NoSuchFieldException, IllegalAccessException {
        ...
        Field addressFieldFB  = Buffer.class.getDeclaredField("address");
        addressFieldFB.setAccessible(true);
        long addressFB = (long)addressFieldFB.get(floatBuffer);
        ...
        assertEquals(addressDB + 1, addressFB);
    }

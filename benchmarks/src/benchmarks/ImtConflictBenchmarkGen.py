...
max_depth = 20 # In practice does not go above 10 using IMT size 64
imt_size = 64
...
for i in xrange(max_depth):
    ...
    for j in xrange(max_depth):
        print("callF{}(c{});".format(64 * (j % (i + 1)), i))
    print("}")
    print("}")
print
...
for i in xrange(max_depth):
    print("public void callF{0}(I{1} i) {{ i.f{0}(); }}".format(64*i, i))
print
...
for i in xrange(max_depth):
    ...
    for j in xrange(imt_size):
        print("default void f{}() {{}}".format(i*64 + j))
    print("}")
print

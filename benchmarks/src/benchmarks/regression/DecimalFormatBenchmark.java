...
public class DecimalFormatBenchmark extends SimpleBenchmark {
    ...
    public static void formatWithGrouping(Object o, int reps) {
    ...
    public static void format(String pattern, Object o, int reps) {
        patternInstance.applyPattern(pattern);
        for (int i = 0; i < reps; i++) {
            patternInstance.format(o);
        }
    }

    public static void format(Object o, int reps) {
        for (int i = 0; i < reps; i++) {
            df.format(o);
        }
    }

    public static void formatToCharacterIterator(Object o, int reps) {
        for (int i = 0; i < reps; i++) {
            df.formatToCharacterIterator(o);
        }
    }


    public static void formatCurrencyUS(Object o, int reps) {
        for (int i = 0; i < reps; i++) {
            dfCurrencyUS.format(o);
        }
    }

    public static void formatCurrencyFR(Object o, int reps) {
        for (int i = 0; i < reps; i++) {
            dfCurrencyFR.format(o);
        }
    }

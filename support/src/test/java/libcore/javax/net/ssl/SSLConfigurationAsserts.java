...
public class SSLConfigurationAsserts extends Assert {
     ...
     */
    private static void assertSSLContextDefaultConfiguration(SSLContext sslContext) {
     ...
     * configuration.
     */
    public static void assertSSLContextDefaultConfigurationRecursive(
            SSLContext sslContext) throws IOException {
        assertSSLContextDefaultConfiguration(sslContext);

        assertSSLSocketFactoryConfigSameAsSSLContextRecursive(
                sslContext.getSocketFactory(), sslContext);
        assertSSLServerSocketFactoryConfigSameAsSSLContextRecursive(
     ...
     */
    public static void assertSSLSocketFactoryDefaultConfigurationRecursive(
     ...
     */
    public static void assertSSLSocketFactoryConfigSameAsSSLContextRecursive(
            SSLSocketFactory sslSocketFactory, SSLContext sslContext) throws IOException {
        assertSSLSocketFactoryConfigSameAsSSLContext(sslSocketFactory, sslContext);
     ...
     */
    public static void assertSSLSocketConfigSameAsSSLContext(SSLSocket sslSocket,
     ...
     * configuration.
     */
    public static void assertSSLServerSocketFactoryDefaultConfigurationRecursive(
     ...
     */
    public static void assertSSLServerSocketFactoryConfigSameAsSSLContextRecursive(
            SSLServerSocketFactory sslServerSocketFactory, SSLContext sslContext)
            throws IOException {
        assertSSLServerSocketFactoryConfigSameAsSSLContext(sslServerSocketFactory, sslContext);
     ...
     */
    public static void assertSSLServerSocketDefaultConfiguration(
            SSLServerSocket sslServerSocket) throws Exception {
      assertFalse(sslServerSocket.getUseClientMode());
     ...
     * configuration.
     */
    public static void assertSSLServerSocketConfigSameAsSSLContext(SSLServerSocket sslServerSocket,
            SSLContext sslContext) {
        assertCipherSuitesEqual(
    ...
    /**
     * Asserts that {@link SSLEngine}'s configuration matches {@code SSLContext's}
     * configuration.
     */
    public static void assertSSLEngineConfigSameAsSSLContext(SSLEngine sslEngine,
            SSLContext sslContext) {
        assertSSLParametersEqual(

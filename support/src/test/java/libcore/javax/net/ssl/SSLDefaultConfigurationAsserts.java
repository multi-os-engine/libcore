...
public abstract class SSLDefaultConfigurationAsserts extends Assert {
   ...
   */
  public static void assertSSLContext(SSLContext sslContext) {
  ...
  public static void assertSSLServerSocketFactory(SSLServerSocketFactory sslServerSocketFactory) {
    ...
    try {
      sslSocket = (SSLServerSocket) sslServerSocketFactory.createServerSocket();
    } catch (IOException e) {
      throw new RuntimeException(e);
    }
    assertSSLServerSocket(sslSocket);
  }
  ...
  public static void assertSSLSocket(SSLSocket sslSocket) {
    assertDefaultSSLParametersClient(sslSocket.getSSLParameters());
   ...
   * operation.
   */
  public static void assertDefaultSSLParametersClient(SSLParameters sslParameters) {
   ...
   * of operation.
   */
  public static void assertSupportedSSLParametersClient(SSLParameters sslParameters) {

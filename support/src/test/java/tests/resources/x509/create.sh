...
openssl req -config ${DIR}/default.cnf -new -nodes -batch | openssl x509 -extfile ${DIR}/default.cnf -extensions invalid_ip_cert -req -signkey privkey.pem -outform d > cert-invalidip.der

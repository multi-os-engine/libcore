...
public class CloseGuardMonitor implements Runnable {
    ...
    public void run() {
        ...
        try {
            // 'Force' a GC and finalize to cause CloseGuards to report warnings. Doesn't loop forever
            // as there are no guarantees that the following code does anything at all so don't want

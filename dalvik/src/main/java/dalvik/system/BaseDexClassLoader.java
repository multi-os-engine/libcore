...
public class BaseDexClassLoader extends ClassLoader {
     ...
     *
     * @deprecated Use #BaseDexClassLoader(String dexPath, File optimizedDirectory,
     * String librarySearchPath, String libraryPermittedPath, ClassLoader parent) instead
     */
     ...
     * @param parent the parent class loader
     */
    protected BaseDexClassLoader(String dexPath, File optimizedDirectory,

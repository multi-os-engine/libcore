        ...
        for(int i=msgStart+1;; ++i) {
            ...
            if(type==Part.Type.REPLACE_NUMBER) {
                if (stockNumberFormatter == null) {
                    stockNumberFormatter = getNumberFormatInstance(MODIFIER_EMPTY, ulocale);
                }
    ...
    private Format createAppropriateFormat(String type, String style) {
        ...
        case TYPE_NUMBER:
            ...
            case MODIFIER_INTEGER:
                newFormat = getNumberFormatInstance(findKeyword(style, modifierList), ulocale);
                break;
            default: // pattern

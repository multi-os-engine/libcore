...
import com.android.i18n.PatternProps;
...
/*public*/ final class MessagePattern implements Cloneable/*, Freezable<MessagePattern>*/ {
     ...
     * The default is DOUBLE_OPTIONAL.
     * <p>
    ...
    MessagePattern(ApostropheMode mode, String pattern) {
        aposMode=mode;
        parse(pattern);
    }
    ...
    private static final ApostropheMode defaultAposMode = ApostropheMode.DOUBLE_OPTIONAL;

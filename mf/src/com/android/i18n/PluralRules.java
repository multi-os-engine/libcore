...
package com.android.i18n; // com.ibm.icu.text;
...
public class PluralRules implements Serializable {
    ...
    private static RuleChain parseRuleChain(String description)
        ...
        RuleChain rc = null;
        String[] rules = Utility_split(description, ';');
    ...
    // From com.ibm.icu.impl.Utility.
    private static String[] Utility_split(String s, char divider) {
        int last = 0;
        int i;
    ...
    // From com.ibm.icu.impl.Utility.
    private static String[] Utility_splitString(String src, String target) {
        return src.split("\\Q" + target + "\\E");
    }

    // From com.ibm.icu.impl.Utility.
    private static String[] Utility_splitWhitespace(String src) {
        return src.split("\\s+");
    }
}

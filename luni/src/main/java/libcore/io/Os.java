...
public interface Os {
    ...
    public void bindSocketAddress(FileDescriptor fd, SocketAddress address) throws ErrnoException, SocketException;
    ...
    public void connectSocketAddress(FileDescriptor fd, SocketAddress address) throws ErrnoException, SocketException;

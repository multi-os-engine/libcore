...
public final class IoUtils {
    ...
    private static class FileReader {
        ...
        public FileReader(String absolutePath) throws IOException {
            // We use IoBridge.open because some callers differentiating
            ...
            // at the cost of copying some code from IoBridge.open here.
            try {
                fd = IoBridge.open(absolutePath, O_RDONLY);
            } catch (FileNotFoundException fnfe) {
                if (absolutePath.charAt(0) != File.separatorChar) {
                    throw new AssertionError(absolutePath + " is not absolute.");
                }

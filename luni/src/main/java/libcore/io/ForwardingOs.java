...
public class ForwardingOs implements Os {
    ...
    public void bindSocketAddress(FileDescriptor fd, SocketAddress address) throws ErrnoException, SocketException { os.bindSocketAddress(fd, address); }
    ...
    public void connectSocketAddress(FileDescriptor fd, SocketAddress address) throws ErrnoException, SocketException { os.connectSocketAddress(fd, address); }

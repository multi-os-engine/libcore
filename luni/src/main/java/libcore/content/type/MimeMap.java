...
public final class MimeMap {
     ...
     */
    private static volatile MemoizingSupplier<MimeMap> instanceSupplier =
     ...
     */
    // @SystemApi(client = MODULE_LIBRARIES)
    public static void setDefaultSupplier(@NonNull Supplier<MimeMap> mimeMapSupplier) {
    ...
    public static final class Builder {
         ...
         */
        // @SystemApi(client = MODULE_LIBRARIES)
        public @NonNull Builder addMimeMapping(@NonNull String mimeSpec, @NonNull List<String> extensionSpecs)
        {

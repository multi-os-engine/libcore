...
public final class ZoneInfoDB {
    ...
    private static void readHeader() {
        ...
        if (!new String(tzdata_version, 0, 6, Charsets.US_ASCII).equals("tzdata") || tzdata_version[11] != 0) {
    ...
    private static void readIndex(BufferIterator it, int indexOffset, int dataOffset) /*throws ErrnoException, IOException*/ {
        it.seek(indexOffset);

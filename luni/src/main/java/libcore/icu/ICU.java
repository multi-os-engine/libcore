...
public final class ICU {
  ...
  public static Locale[] getAvailableLocales() {
    if (availableLocalesCache == null) {
      ...
      // TODO: Once there is a public API in ICU to get this data, use that instead of the impl
      // class. A ticket was filed requesting this: http://bugs.icu-project.org/trac/ticket/11915.

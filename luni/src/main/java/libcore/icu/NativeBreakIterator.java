...
public final class NativeBreakIterator implements Cloneable {
    ...
    public static NativeBreakIterator getCharacterInstance(Locale locale) {
        return new NativeBreakIterator(getCharacterInstanceImpl(locale.toString()), BI_CHAR_INSTANCE);
    }

    public static NativeBreakIterator getLineInstance(Locale locale) {
        return new NativeBreakIterator(getLineInstanceImpl(locale.toString()), BI_LINE_INSTANCE);
    }

    public static NativeBreakIterator getSentenceInstance(Locale locale) {
        return new NativeBreakIterator(getSentenceInstanceImpl(locale.toString()), BI_SENT_INSTANCE);
    }

    public static NativeBreakIterator getWordInstance(Locale locale) {
        return new NativeBreakIterator(getWordInstanceImpl(locale.toString()), BI_WORD_INSTANCE);
    }

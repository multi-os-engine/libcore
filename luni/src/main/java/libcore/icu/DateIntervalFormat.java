...
public final class DateIntervalFormat {
  ...
  // TODO: remove this; DateUtils should always just call the more general form.
  public static String formatDateRange(long startMs, long endMs, int flags) {
    return formatDateRange(startMs, endMs, flags, null);
  }
  ...
  public static String formatDateRange(Locale locale, TimeZone tz, long startMs, long endMs, int flags) {
    ...
    String result = formatDateInterval(skeleton, locale.toString(), startMs, endMs);

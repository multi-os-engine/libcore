...
public final class RelativeDateTimeFormatter {
  ...
  // {@link android.text.format#getRelativeTimeSpanString(long, long, long, int)}
  //
  // See the comments in getRelativeTimeSpanString(Locale, TimeZone, long,
  // long, long, int) for the implementation details.
  ...
  //
  // It takes two additional parameters of Locale and TimeZone than the public
  // API. Default locale and default timezone will be used if they are null.
  // Caller may also specify FORMAT_ABBREV_RELATIVE or FORMAT_ABBREV_ALL in
  // 'flags' to get the abbreviated forms when available. When 'time' equals
  // to 'now', it always returns a string like '0 seconds/minutes/... ago'
  // according to minResolution.
  ...
  // {@link android.text.format#getRelativeTimeSpanString(long, long, long, int)}
  //
  // See the comments in getRelativeDateTimeString(Locale, TimeZone, long,
  // long, long, long, int) below for details.
  ...
  // API. Default locale and default timezone will be used if they are null.
  // Caller may also specify FORMAT_ABBREV_RELATIVE or FORMAT_ABBREV_ALL in
  // 'flags' to get the abbreviated forms when available.
  //
  ...
  // synchronized block, since the formatter returned by getFormatter() may
  // have been evicted by the time of the call to formatter->action().

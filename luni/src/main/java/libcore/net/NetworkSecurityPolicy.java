...
public abstract class NetworkSecurityPolicy {
    ...
    /**
     * Returns {@code true} cleartext network traffic (e.g. HTTP, FTP, XMPP, IMAP, SMTP -- without
     * TLS or STARTTLS) is permitted for all network communications of this process.
     *

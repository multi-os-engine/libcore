...
public class NetworkSecurityPolicy {
    ...
    private static boolean cleartextTrafficPermitted = false;

    /**
     * Returns whether cleartext network traffic (e.g., HTTP, FTP, XMPP, IMAP, SMTP -- without TLS
     * or STARTTLS) is permitted for this process.
     */

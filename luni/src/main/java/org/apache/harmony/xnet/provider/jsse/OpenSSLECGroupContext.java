...
final class OpenSSLECGroupContext {
    ...
    public static OpenSSLECGroupContext getInstance(int type, BigInteger p, BigInteger a,
        ...
        OpenSSLECPointContext generator = new OpenSSLECPointContext(type, group,
                NativeCrypto.EC_POINT_new(ctx));

        NativeCrypto.EC_POINT_set_affine_coordinates(type, ctx, generator.getContext(),
    ...
    public ECParameterSpec getECParameterSpec() {
        ...
        final byte[][] curveParams = NativeCrypto.EC_GROUP_get_curve(curveType, groupCtx);
        ...
        final OpenSSLECPointContext generatorCtx = new OpenSSLECPointContext(type, this,

...
public final class NativeCrypto {
    ...
    /**
     * Used to request EC_GROUP_new_curve_GFp to EC_GROUP_new_curve and other
     * functions that use "int type" below.
     */
    public static final int EC_CURVE_GFP = 1;

    /**
     * Used to request EC_GROUP_new_curve_GF2m to EC_GROUP_new_curve and other
     * functions that use "int type" below.
     */
    ...
    public static native byte[][] EC_GROUP_get_curve(int type, int groupRef);
    ...
    public static native byte[][] EC_POINT_get_affine_coordinates(int type, int groupCtx,
            int pointCtx);

    public static native void EC_POINT_set_affine_coordinates(int type, int groupCtx, int pointCtx,
            byte[] x, byte[] y);

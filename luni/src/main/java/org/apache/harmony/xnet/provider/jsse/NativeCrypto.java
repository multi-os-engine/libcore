...
public final class NativeCrypto {
    ...
    public static native long PEM_read_bio_X509_AUX(long bioCtx);
    ...
    public static native String get_X509_sig_alg_oid(long ctx);
    ...
    public static native int X509_cmp_time(long asn1TimeCtx, long timeMillis);

    public static native int X509_cmp_current_time(long asn1TimeCtx);

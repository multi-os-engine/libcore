...
public abstract class ByteBuffer extends Buffer implements Comparable<ByteBuffer> {
     ...
     * byte buffers).  If {@code allow} is {@code false}, {@link #isValid}
     * will return false, and any attempt to dereference the buffer will
     * throw an exception.  Use this if the underlying memory can be freed
     * by external forces. If {@code true}, the buffer will become again
     * useable, unless it has been freed.  Use this if the underlying memory
     * is stable and cannot be freed by external forces.
     *
     * @hide
     */

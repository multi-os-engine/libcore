 ...
 * {@link #truncate}, {@link #position} and {@link #write} for details. The current size can also be
 * queried.
 *
...
public interface SeekableByteChannel extends ByteChannel {
   ...
   * operations will succeed but they will fill the bytes between the current end of the data source
   ...
   * size are removed. If there are no bytes beyond the given size then the contents are unmodified.
   *
   ...
   * {@link java.nio.Buffer#position() position}. The buffer's {@link java.nio.Buffer#limit() limit}
   * is not changed.
   *

...
final class ShortArrayBuffer extends ShortBuffer {
  ...
  ShortArrayBuffer(int capacity, short[] backingArray, int arrayOffset, boolean isReadOnly) {
    super(capacity);
  ...
  static ShortArrayBuffer copy(ShortArrayBuffer other, int markOfOther, boolean isReadOnly) {

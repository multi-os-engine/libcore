...
public abstract class CharsetEncoder {
     ...
     * {@link ByteBuffer#remaining() out.remaining()}. If an encoder wants to
     * write more bytes than the output buffer's available remaining space, then
     * it will return {@code CoderResult.OVERFLOW}. This method must be called again
     * with a byte buffer that has free space.
     * <p>
     * If the encoder was asked to flush its output when its input is incomplete,
     * it may return {@code CodeResult.MALFORMED}.
     * <p>
     * In all other cases the encoder will return {@code CoderResult.UNDERFLOW},
     * which signifies that encoding was successful.
     * <p>
     ...
     *         <code>CoderResult.OVERFLOW</code> or
     *         <code>CoderResult.MALFORMED</Code>
     * @throws IllegalStateException

 ...
 *
 * Modified UTF-8 is a simple variation of UTF-8 in which {@code \u0000} is encoded as
...
public class ModifiedUtf8 {
    ...
    public static long countBytes(String s, boolean shortLength) throws UTFDataFormatException {
        ...
        // unsigned.
        if (shortLength && counter > Short.MAX_VALUE * 2 + 1) {

...
final class IntArrayBuffer extends IntBuffer {
  ...
  IntArrayBuffer(int capacity, int[] backingArray, int arrayOffset, boolean isReadOnly) {
    super(capacity);
  ...
  static IntArrayBuffer copy(IntArrayBuffer other, int markOfOther, boolean isReadOnly) {

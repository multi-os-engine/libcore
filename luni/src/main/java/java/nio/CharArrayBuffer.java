...
final class CharArrayBuffer extends CharBuffer {
  ...
  CharArrayBuffer(int capacity, char[] backingArray, int arrayOffset, boolean isReadOnly) {
    super(capacity);
  ...
  static CharArrayBuffer copy(CharArrayBuffer other, int markOfOther, boolean isReadOnly) {

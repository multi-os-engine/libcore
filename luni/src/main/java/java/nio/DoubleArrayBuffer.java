...
final class DoubleArrayBuffer extends DoubleBuffer {
  ...
  DoubleArrayBuffer(int capacity, double[] backingArray, int arrayOffset, boolean isReadOnly) {
    super(capacity);
  ...
  static DoubleArrayBuffer copy(DoubleArrayBuffer other, int markOfOther, boolean isReadOnly) {

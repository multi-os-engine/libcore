...
final class LongArrayBuffer extends LongBuffer {
  ...
  LongArrayBuffer(int capacity, long[] backingArray, int arrayOffset, boolean isReadOnly) {
    super(capacity);
  ...
  static LongArrayBuffer copy(LongArrayBuffer other, int markOfOther, boolean isReadOnly) {

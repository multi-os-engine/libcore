 ...
 * cannot be used to predict how many bytes can be read from {@link #getInputStream()}
 * for compressed streams. Instead, read that stream until it is exhausted: when

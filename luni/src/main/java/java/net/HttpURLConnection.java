...
public abstract class HttpURLConnection extends URLConnection {
     ...
     *
     * <p>Implementation details: The {@code chunkLength} is treated as a hint:
     * chunks sent to the server may actually be larger or smaller. To force a
     * chunk to be sent to the server call {@link java.io.OutputStream#flush()}.
     *

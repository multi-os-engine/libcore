...
public class InetSocketAddress extends SocketAddress {
     ...
     * 65535 inclusive.
     *
     * @param port the specified port number to which the socket is bound.
     */
     ...
     *
     * @param port the specified port number to which the socket is bound.
     * @param address the specified address to which the socket is bound.
     */
     ...
     *
     * @param port the specified port number to which the socket is bound.
     * @param host the specified hostname to which the socket is bound.
     */

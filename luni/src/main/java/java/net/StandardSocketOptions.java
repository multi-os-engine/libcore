 ...
 * <p>
 * See {@link java.nio.channels.NetworkChannel} for more information, particularly
...
public final class StandardSocketOptions {
   ...
   * <p>
   * See <a href="http://tools.ietf.org/rfc/rfc1112.txt">RFC 1112: Host Extensions for IP
   * Multicasting</a> for more information about IP multicast.
   *
   * @see java.net.MulticastSocket#setInterface(InetAddress)
   */
   ...
   * <p>
   * See <a href="http://www.ietf.org/rfc/rfc1349.txt">RFC 1349</a> for more about IPv4
  ...
  /**
   * Whether broadcasting on datagram sockets is enabled or disabled. This option
   * must be enabled to send broadcast messages. The default value is false.
   */
   ...
   * <p>
   * See <a href="http://www.ietf.org/rfc/rfc1122.txt">RFC 1122: Requirements for Internet Hosts
   * -- Communication Layers</a> for more information on keep-alive.
   */
   ...
   * sent.
   *
   * <p>If this option is negative this option is disabled and {@code close} will return
   * immediately and the socket close will be handled in the background. This is the default
   * value.
   *
   ...
   *
   * <p>Valid timeout values for this option are in the range 0 to 65535 inclusive. (Larger
   ...
   * <p>
   * See <a href="http://www.ietf.org/rfc/rfc1323.txt">RFC1323: TCP Extensions for High
   ...
   * <p>
   * For connection-oriented sockets, if this option is disabled and there is another socket
   ...
   * <p>
   * See <a href="https://www.ietf.org/rfc/rfc793.txt">RFC 793: Transmission Control Protocol</a>
   ...
   * This is a hint to the kernel; the kernel may use a larger buffer.
   * <p>
   * For datagram sockets, it is implementation-defined whether packets larger than this size can
   * be sent.
   */
   ...
   * low packet efficiency. When set to false, the socket implementation uses buffering to try to
   * reach a higher packet efficiency.
   * <p>
   * See <a href="http://www.ietf.org/rfc/rfc1122.txt">RFC 1122: Requirements for Internet Hosts
   * -- Communication Layers</a> for more information about buffering and the Nagle algorithm.
   */

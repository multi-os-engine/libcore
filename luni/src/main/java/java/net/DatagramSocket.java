...
public class DatagramSocket implements Closeable {
     ...
     * @hide used in java.nio
     */
    public void initBound(InetAddress localAddress, int localPort) {
        isBound = true;
        impl.initBound(localAddress, localPort);
    }
     ...
     * 
     * <p>Note: Also call {@link #initBound} to modify the bind() state if a connection may also
     * have performed an implicit bind().
     *
     * @hide used in java.nio
     */
    public void initConnected(InetAddress remoteAddress, int remotePort) {
        isConnected = true;
        this.address = remoteAddress;
        this.port = remotePort;
        impl.initConnected(remoteAddress, remotePort);
    }

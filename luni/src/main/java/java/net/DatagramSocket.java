...
public class DatagramSocket implements Closeable {
    ...
    /**
     * Returns the local address to which this socket is bound, an address for which
     * {@link InetAddress#isAnyLocalAddress()} will return {@code true} if this socket is not yet
     * bound, or {@code null} if this socket is closed.
     */
     ...
     * 
     * <p>Note: Also call {@link #onBind} to modify the bind() state if a connection may also
     * have performed an implicit bind().
     *
     * @hide used in java.nio
     */
    ...
    /**
     * Returns the {@code SocketAddress} this socket is bound to, or null for an unbound or closed
     * socket.
     */

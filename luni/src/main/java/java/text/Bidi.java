...
public final class Bidi {
    ...
    private static final int ICU_DEFAULT_LEFT_TO_RIGHT =
            com.ibm.icu.text.Bidi.DIRECTION_DEFAULT_LEFT_TO_RIGHT;

    private static final int ICU_DEFAULT_RIGHT_TO_LEFT =
            com.ibm.icu.text.Bidi.DIRECTION_DEFAULT_RIGHT_TO_LEFT;

    private static int translateConstToIcu(int javaInt) {
        if (javaInt == DIRECTION_DEFAULT_LEFT_TO_RIGHT) {
            return ICU_DEFAULT_LEFT_TO_RIGHT;
        }
        if (javaInt == DIRECTION_DEFAULT_RIGHT_TO_LEFT) {
            return ICU_DEFAULT_RIGHT_TO_LEFT;
        }
        // The other constants are the same in ICU4J.
        return javaInt;
    }
    ...
    public int getRunCount() {
        return (icuBidi.getRunCount() == 0) ? 1 : icuBidi.getRunCount();
    }
    ...
    public int getRunLevel(int run) {
        return (icuBidi.getRunCount() == 0) ? icuBidi.getBaseLevel() : icuBidi.getRunLevel(run);
    }
    ...
    public int getRunLimit(int run) {
        return (icuBidi.getRunCount() == 0) ? icuBidi.getLength() : icuBidi.getRunLimit(run);
    }
    ...
    public int getRunStart(int run) {
        return (icuBidi.getRunCount() == 0) ? 0 : icuBidi.getRunStart(run);
    }

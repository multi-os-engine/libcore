...
public class DecimalFormatSymbols implements Cloneable, Serializable {
    ...
    public char getMinusSign() {
        ...
        // Return the minus sign from Locale.ROOT instead of crashing. None of the parsers
        ...
        //
        // Callers that call this method to format strings and expect them to be parseable by
    ...
    public char getPercent() {
        ...
        // Return the percent sign from Locale.ROOT instead of crashing. None of the parsers

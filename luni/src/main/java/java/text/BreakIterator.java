...
public abstract class BreakIterator implements Cloneable {
    ...
    public static Locale[] getAvailableLocales() {
        return com.android.ibm.icu.text.BreakIterator.getAvailableLocales();
    }
    ...
    public static BreakIterator getCharacterInstance(Locale locale) {
        return new IcuIteratorWrapper(
                com.android.ibm.icu.text.BreakIterator.getCharacterInstance(locale));
    }
    ...
    public static BreakIterator getLineInstance(Locale locale) {
        return new IcuIteratorWrapper(
                com.android.ibm.icu.text.BreakIterator.getLineInstance(locale));
    }
    ...
    public static BreakIterator getSentenceInstance(Locale locale) {
        return new IcuIteratorWrapper(
                com.android.ibm.icu.text.BreakIterator.getSentenceInstance(locale));
    }
    ...
    public static BreakIterator getWordInstance(Locale locale) {
        return new IcuIteratorWrapper(
                com.android.ibm.icu.text.BreakIterator.getWordInstance(locale));
    }

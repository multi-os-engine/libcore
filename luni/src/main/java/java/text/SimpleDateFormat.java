...
public class SimpleDateFormat extends DateFormat {
    ...
    private int parseFractionalSeconds(String string, int offset, int count) {
        ...
        // NOTE: We could've instead done this using two parses. The first parse
        // for |count| digits (to verify the date matched the format), and then a
        // second parse that looked at just the first three digits. That would've
        // avoided the floating point arithmetic, but would've demanded

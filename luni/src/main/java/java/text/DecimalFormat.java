...
public class DecimalFormat extends NumberFormat {
    ...
    public AttributedCharacterIterator formatToCharacterIterator(Object object) {
        ...
        return icuDecimalFormat.formatToCharacterIterator(object);
    }
    ...
    public static FieldPosition getIcuFieldPosition(FieldPosition fp) {
        ...
        if (fp.getFieldAttribute() == Field.INTEGER) {
            ...
            icuFieldPosition = new FieldPosition(com.ibm.icu.text.NumberFormat.Field.DECIMAL_SEPARATOR);
        } else if (fp.getFieldAttribute() == Field.EXPONENT_SYMBOL) {
            icuFieldPosition = new FieldPosition(com.ibm.icu.text.NumberFormat.Field.EXPONENT_SYMBOL);
            ...
            icuFieldPosition = new FieldPosition(com.ibm.icu.text.NumberFormat.Field.GROUPING_SEPARATOR);
    ...
    public void setMinimumIntegerDigits(int value) {
        ...
        icuDecimalFormat.setMinimumIntegerDigits(getMaximumIntegerDigits());
    }

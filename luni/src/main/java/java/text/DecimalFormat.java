...
public class DecimalFormat extends NumberFormat {
    ...
    private transient String cachedIcuPattern;
    ...
    public void applyLocalizedPattern(String pattern) {
        ...
        updateFieldsFromIcu();
        // Note: Do not cache localized pattern because the toPattern specification document
        // says that it returns a non-locaalized pattern.
    }
    ...
    public AttributedCharacterIterator formatToCharacterIterator(Object object) {
        ...
        for (int i = original.getBeginIndex(); i < original.getEndIndex(); i++) {
            ...
            for (AttributedCharacterIterator.Attribute attribute
                ...
                // If the attribute starts at this position then add it (to avoid adding attributes
                // that have already been added previously).
                if (original.getRunStart(attribute) == i) {

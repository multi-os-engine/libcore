...
public class DecimalFormat extends NumberFormat {
    ...
    public AttributedCharacterIterator formatToCharacterIterator(Object object) {
        ...
        Set<AttributedCharacterIterator.Attribute> attributes = original.getAllAttributeKeys();
        Iterator<AttributedCharacterIterator.Attribute> iter = attributes.iterator();

        AttributedString result = new AttributedString(text);

        while (iter.hasNext()) {
            AttributedCharacterIterator.Attribute attribute = iter.next();
            original.setIndex(0);
            while (original.current() != CharacterIterator.DONE) {
                ...
                if (value != null) {
                    result.addAttribute(getJavaAttributes(attribute), getJavaAttributes(attribute), start, end);
                }
    ...
    public String toString() { return icuDecimalFormat.toString(); }
}

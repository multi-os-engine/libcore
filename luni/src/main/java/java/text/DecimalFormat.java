...
public class DecimalFormat extends NumberFormat {
    ...
    public void setRoundingMode(RoundingMode roundingMode) {
        ...
        // Java's DecimalFormat does not allow specification of a rounding increment  If anything
        // other than 0.0 is used here the resulting DecimalFormat cannot be deserialized because
        // the serialization format does not include rounding increment information.

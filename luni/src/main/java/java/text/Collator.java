...
public abstract class Collator implements Comparator<Object>, Cloneable {
    ...
    // TODO: when ICU4J is expoed update this constant to the ICU4J equivalent.
    /**
     * Constant used to specify the collation strength.
     */
    ...
    Collator(com.ibm.icu.text.RuleBasedCollator icuColl) {
    ...
    public Object clone() {
        try {
            ...
            clone.icuColl = (com.ibm.icu.text.RuleBasedCollator) icuColl.clone();
            return clone;
    ...
    public static Collator getInstance(Locale locale) {
        ...
        return new RuleBasedCollator((com.ibm.icu.text.RuleBasedCollator)
                com.ibm.icu.text.RuleBasedCollator.getInstance(locale));
    }

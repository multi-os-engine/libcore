...
import libcore.util.NativeAllocation;
...
final class BigInt {
    ...
    private static long freeFunction = NativeBN.freeFunction();
    private static long size = NativeBN.size();
    ...
    private void makeValid() {
        if (this.bignum == 0) {
            ...
            NativeAllocation.registerNativeAllocation(size);
            NativeAllocation.registerNativeFree(this, this.bignum, freeFunction, size);
        }
    }
    ...
    private static BigInt newBigInt() {
        ...
        NativeAllocation.registerNativeAllocation(size);
        NativeAllocation.registerNativeFree(bi, bi.bignum, freeFunction, size);
        return bi;
    }

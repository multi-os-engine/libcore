...
public final class Character implements Serializable, Comparable<Character> {
     ...
     */
    public static boolean isDefined(char c) { return UCharacter.isDefined(c); }
    ...
    public static boolean isWhitespace(int codePoint) {
        ...
        // From UCharacter#isWhitespace <<This API tries to sync with the semantics of Java
        // java.lang.Character.isWhitespace(), but it may not return
        // the exact same results because of the Unicode version
        // difference.>> The native method was defined as u_iswhitespace .

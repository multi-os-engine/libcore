...
public final class System {
     ...
     * version. In progress - theoretically functions as an additional type
     * implementation if type T detection and Object identifying is valid.
     */

    //private static final int ARRAYCOPY_SHORT_T_ARRAY_THRESHOLD = 128;

    /**
     * The T[] specialized version of arraycopy().
     *
     * @hide internal use only
     */
    /* public static void arraycopy(T[] src, int srcPos, T[] dst, int dstPos, int length) {
    ...
    private static final int ARRAYCOPY_SHORT_INT_ARRAY_THRESHOLD = 16;
    ...
    private static final int ARRAYCOPY_SHORT_LONG_ARRAY_THRESHOLD = 16;
    ...
    /**
     * The boolean[] specialized version of arraycopy().cd 
     *
     * @hide internal use only
     */

...
public final class System {
    ...
    private static Properties userModifiableProperties;
    ...
    static {
        ...
        userModifiableProperties = createUserModifiableProperties();
    ...
    public static Properties getProperties() {
        return userModifiableProperties;
    }

    private static Properties getUserModifiableProperties() {
        return userModifiableProperties;
    }
    ...
    private static Properties createUserModifiableProperties() {
        Properties p = new PropertiesWithNonOverrideableDefaults(systemProperties);
    ...
    public static String getProperty(String name, String defaultValue) {
        ...
        return getUserModifiableProperties().getProperty(name, defaultValue);
    }
    ...
    public static String setProperty(String name, String value) {
        checkPropertyName(name);
        return (String) getUserModifiableProperties().setProperty(name, value);
    }
    ...
    public static String clearProperty(String name) {
        ...
        String oldProperty = systemProperties.getProperty(name);
        if (oldProperty != null) {
            logE("Disallowing attempt to clear system property \"" + name + "\".",
                    new Throwable());
            return null;
        }

        return (String) getUserModifiableProperties().remove(name);
    }
    ...
    public static void setProperties(Properties p) {
        PropertiesWithNonOverrideableDefaults userProperties =
                new PropertiesWithNonOverrideableDefaults(systemProperties);
        if (p != null) {
            userProperties.putAll(p);
        }

        userModifiableProperties = userProperties;
    }

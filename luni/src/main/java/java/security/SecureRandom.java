 ...
 * {@link #setSeed}, depending on the underlying implementation, may completely
 * replace the default seed causing the instance to return a predictable
 * sequence of numbers or it may remain random. Therefore, due to variations
 * in implementations, it is not recommended to use {@code setSeed} at all.
 */

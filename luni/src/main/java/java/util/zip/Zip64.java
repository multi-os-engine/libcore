...
public class Zip64 {
    ...
    public static void appendZip64ExtendedInfoToExtras(ZipEntry ze) {
        ...
        if (ze.extra == null) {
            ...
            // We copy existing extras over and put the zip64 extended info at the end. This will
            // break in the presence of "old style" extras which don't contain headers and lengths.
            // The spec is again silent about these inconsistencies.

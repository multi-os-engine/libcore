...
public class ZipOutputStream extends DeflaterOutputStream implements ZipConstants {
     ...
     * the standard zip format or if we exceeded the number of entries
     */
     ...
     * to the start of the current entry header is > 0xFFFFFFFF. Note that while the
     */
    private boolean currentEntryNeedsZip64;

    /**
     * Whether we force all entries in this archive to have a zip64 extended info record.
     * This ofcourse implies that the {@code currentEntryNeedsZip64} and
    ...
    public void closeEntry() throws IOException {
        ...
        if (currentEntry.getMethod() != STORED) {
            ...
            // Data descriptor signature and CRC are 4 bytes each for both zip
            // and zip64.
        ...
        nameBytes = null;
        if (currentEntry.extra != null) {
            // NOTE: This field might include this entries zip64 extended info record.
    ...
    public void putNextEntry(ZipEntry ze) throws IOException {
        ...
        if (ze.comment != null) {
            ...
            // The comment is not written out until the entry is ffinished, but it is validated here
            // to fail-fast.
        ...
        if (currentEntryNeedsZip64) {
            currentEntry.extra = Zip64.appendZip64ExtendedInfoToExtras(currentEntry);
        }
    ...
    private void checkAndSetZip64Requirements(ZipEntry entry) {
        ...
        // entries (unless they trigger the checks below, i.e).

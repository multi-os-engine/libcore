...
public class ZipFile implements Closeable, ZipConstants {
    ...
    private void readCentralDir() throws IOException {
        ...
        // Seek back past the oecd signature so that we can continue with our search.
        ...
        // Note that zip64 eocd records don't contain comment lengths so we'll need to parse
        // the regular record just for the comment length (sigh).

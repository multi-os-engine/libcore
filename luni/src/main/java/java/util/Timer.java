...
public class Timer {
    ...
    // Used to to notify the execution thread about changes (cancellation, new tasks). Each permit
    // indicates a change that might affect the execution thread.
    ...
    private static class ExecutionThreadRunnable implements Runnable {
        ...
        private final ReentrantLock priorityQueueLock;
        ...
        private ExecutionThreadRunnable(
                ...
                ReentrantLock priorityQueueLock,
        ...
        public void run() {
            try {
                ...
                if (priorityQueueLock.isHeldByCurrentThread()) {
                    priorityQueueLock.unlock();
                }
            }
        }

...
public class JarFile extends ZipFile {
    ...
    public JarFile(File file, boolean verify, int mode) throws IOException {
        ...
        // Step 1: Scan the central directory for meta entries and the
        // MANIFEST file, and read them fully.
        HashMap<String, byte[]> metaEntries = readMetaEntriesAndManifest(this, verify);
    ...
    public Manifest getManifest() throws IOException {
        ...
        manifest = new Manifest(manifestBytes, verifier != null);
        manifestBytes = null;
     ...
     * added to {@code metaEntriesMap}.
     *
     * @throws IOException
     *             if there is a problem reading the jar file entries.
     */
    static HashMap<String, byte[]> readMetaEntriesAndManifest(ZipFile zipFile,

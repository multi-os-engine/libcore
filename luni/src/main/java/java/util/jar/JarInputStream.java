...
public class JarInputStream extends ZipInputStream {
    ...
    public JarInputStream(InputStream stream, boolean verify) throws IOException {
        ...
        // There was no manifest available, so we should return whatever entry
        // we're at on the next call of getNextJarEntry.
    ...
    public void closeEntry() throws IOException {
        // NOTE: This was the old behaviour. A call to closeEntry() before the

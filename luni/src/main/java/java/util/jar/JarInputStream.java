...
// the Manifest and META-INF directory *need not appear first*. This class will
// silently skip certificate checks for jar files where the manifest isn't the
// first entry. To do this correctly, we need O(input_stream_length) memory.

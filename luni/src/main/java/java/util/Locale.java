...
public final class Locale implements Cloneable, Serializable {
    ...
    public static final class Builder {
        ...
        public Builder setLanguage(String language) {
            ...
            if (!isValidBcp47Alpha(lowercaseLanguage, 2, 8)) {
        ...
        public Builder setScript(String script) {
            ...
            if (!isValidBcp47Alpha(lowercaseScript, 4, 4)) {
         ...
         * by a separator ({@code "-"} or {@code "_"}). Each subtag must be between
    ...
    public Locale(String language, String country, String variant, String scriptCode,
        ...
        if (fromPublicConstructor) {
            ...
            this.extensions = Collections.unmodifiableMap(
                    new HashMap<Character, String>(extensions));
        }
    }
    ...
    private String toNewString(String languageCode, String countryCode,
        ...
        // Note that the this is notably different from the BCP-47 spec (supposedly for
        ...
        if (this.extensions != null && !this.extensions.isEmpty()) {
            result.append('-');
            result.append(serializeExtensions(this.extensions));
        }

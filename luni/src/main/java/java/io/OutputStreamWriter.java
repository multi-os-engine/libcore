...
public class OutputStreamWriter extends Writer {
    ...
    /**
     * Closes this writer. This implementation flushes the buffer but DOES NOT flush
     * the target stream. The target stream is then closed and the resources for the

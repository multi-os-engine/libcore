...
public abstract class InputStream extends Object implements Closeable {
    ...
    /**
     * Skips at most {@code n} bytes in this stream. The number of actual bytes
     * skipped may be anywhere between 0 and {@code n}. If {@code n} is
     * negative, this method does nothing and returns 0, but some subclasses may
     * throw.
     * <p>
     ...
     *
     * @param byteCount the actual number of bytes to skip.

...
static void ICU_setDefaultLocaleNative(JNIEnv* env, jclass, jstring javaLocaleName) {
  Locale locale = getLocale(env, javaLocaleName);
  UErrorCode status = U_ZERO_ERROR;
  ...
  // locale as the default shouldn't have any realistic expecation that
...
static JNINativeMethod gMethods[] = {
    ...
    NATIVE_METHOD(ICU, setDefaultLocaleNative, "(Ljava/lang/String;)V"),

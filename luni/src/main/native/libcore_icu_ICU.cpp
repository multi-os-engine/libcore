...
static JNICALL jstring ICU_addLikelySubtags2(JNIEnv* env, jclass, jstring javaLocaleName) {
    UErrorCode status = U_ZERO_ERROR;
...
static JNICALL jstring ICU_addLikelySubtags(JNIEnv* env, jclass jc, jstring javaLocaleName) {
#ifndef USE_APPLE_CF
...
static JNICALL jstring ICU_getScript(JNIEnv* env, jclass, jstring javaLocaleName) {
...
static JNICALL jint ICU_getCurrencyFractionDigits(JNIEnv* env, jclass, jstring javaCurrencyCode) {
...
static JNICALL jint ICU_getCurrencyNumericCode(JNIEnv* env, jclass, jstring javaCurrencyCode) {
  ScopedJavaUnicodeString currencyCode(env, javaCurrencyCode);
  if (!currencyCode.valid()) {
    return 0;
  }
...
static JNICALL jstring ICU_getCurrencyCode(JNIEnv* env, jclass, jstring javaCountryCode) {
    UErrorCode status = U_ZERO_ERROR;
...
#else
    const jchar* chars = CAST_TO_CONST_JCHAR(ures_getString(currencyId.get(), &charCount, &status));
#endif
...
#else
  return (charCount == 0) ? NULL : env->NewString(CAST_TO_CONST_JCHAR(chars), charCount);
#endif
}
#else
...
static JNICALL jstring ICU_getCurrencyCode2(JNIEnv* env, jclass, jstring javaCountryCode) {
...
static JNICALL jstring ICU_getCurrencyDisplayName(JNIEnv* env, jclass, jstring javaLanguageTag, jstring javaCurrencyCode) {
#ifndef USE_APPLE_CF
...
static JNICALL jstring ICU_getCurrencySymbol2(JNIEnv* env, jclass, jstring javaLanguageTag, jstring javaCurrencyCode) {
#ifndef USE_APPLE_CF
...
static JNICALL jstring ICU_getCurrencySymbol(JNIEnv* env, jclass, jstring javaLanguageTag, jstring javaCurrencyCode) {
    return ICU_getCurrencySymbol2(env, nullptr, javaLanguageTag, javaCurrencyCode);
}

static JNICALL jstring ICU_getDisplayCountryNative(JNIEnv* env, jclass, jstring javaTargetLanguageTag, jstring javaLanguageTag) {
  ScopedIcuLocale icuLocale(env, javaLanguageTag);
  if (!icuLocale.valid()) {
    return NULL;
  }
...
#else
  return env->NewString(CAST_TO_CONST_JCHAR(str.getBuffer()), str.length());
#endif
}

static JNICALL jstring ICU_getDisplayLanguageNative(JNIEnv* env, jclass, jstring javaTargetLanguageTag, jstring javaLanguageTag) {
  ScopedIcuLocale icuLocale(env, javaLanguageTag);
  if (!icuLocale.valid()) {
    return NULL;
  }
...
static JNICALL jstring ICU_getDisplayScriptNative(JNIEnv* env, jclass, jstring javaTargetLanguageTag, jstring javaLanguageTag) {
  ScopedIcuLocale icuLocale(env, javaLanguageTag);
  if (!icuLocale.valid()) {
    return NULL;
  }
...
static JNICALL jstring ICU_getDisplayVariantNative(JNIEnv* env, jclass, jstring javaTargetLanguageTag, jstring javaLanguageTag) {
  ScopedIcuLocale icuLocale(env, javaLanguageTag);
  if (!icuLocale.valid()) {
    return NULL;
  }
...
static JNICALL jstring ICU_getISO3Country(JNIEnv* env, jclass, jstring javaLanguageTag) {
  ScopedIcuLocale icuLocale(env, javaLanguageTag);
  if (!icuLocale.valid()) {
    return NULL;
  }
...
static JNICALL jstring ICU_getISO3Language(JNIEnv* env, jclass, jstring javaLanguageTag) {
  ScopedIcuLocale icuLocale(env, javaLanguageTag);
  if (!icuLocale.valid()) {
    return NULL;
  }
...
static JNICALL jobjectArray ICU_getISOCountriesNative(JNIEnv* env, jclass) {
    return toStringArray(env, icu::Locale::getISOCountries());
}

static JNICALL jobjectArray ICU_getISOLanguagesNative(JNIEnv* env, jclass) {
    return toStringArray(env, icu::Locale::getISOLanguages());
}

static JNICALL jobjectArray ICU_getAvailableLocalesNative(JNIEnv* env, jclass) {
#ifndef USE_APPLE_CF
...
static JNICALL jobjectArray ICU_getAvailableBreakIteratorLocalesNative(JNIEnv* env, jclass) {
#ifndef USE_APPLE_CF
...
static JNICALL jobjectArray ICU_getAvailableCalendarLocalesNative(JNIEnv* env, jclass) {
#ifndef USE_APPLE_CF
...
static JNICALL jobjectArray ICU_getAvailableCollatorLocalesNative(JNIEnv* env, jclass) {
#ifndef USE_APPLE_CF
...
static JNICALL jobjectArray ICU_getAvailableDateFormatLocalesNative(JNIEnv* env, jclass) {
#ifndef USE_APPLE_CF
...
static JNICALL jobjectArray ICU_getAvailableNumberFormatLocalesNative(JNIEnv* env, jclass) {
#ifndef USE_APPLE_CF
...
#else
        ScopedLocalRef<jstring> s(env, env->NewString(CAST_TO_CONST_JCHAR(valueArray[i].getBuffer()),valueArray[i].length()));
#endif
...
#else
    setStringField(env, obj, fieldName, env->NewString(CAST_TO_CONST_JCHAR(chars), charCount));
#endif
  } else {
...
#else
    setStringField(env, obj, fieldName, env->NewString(CAST_TO_CONST_JCHAR(chars), value.length()));
#endif
}
...
static JNICALL jboolean ICU_initLocaleDataNative2(JNIEnv* env, jclass, jstring javaLanguageTag, jobject localeData) {
...
static JNICALL jboolean ICU_initLocaleDataNative(JNIEnv* env, jclass, jstring javaLanguageTag, jobject localeData) {
#ifndef USE_APPLE_CF
...
static JNICALL jstring ICU_toLowerCase(JNIEnv* env, jclass, jstring javaString, jstring javaLanguageTag) {
...
#else
    return s == original ? javaString : env->NewString(CAST_TO_CONST_JCHAR(s.getBuffer()), s.length());
#endif
#else
...
static JNICALL jstring ICU_toUpperCase(JNIEnv* env, jclass, jstring javaString, jstring javaLanguageTag) {
  ScopedJavaUnicodeString scopedString(env, javaString);
  if (!scopedString.valid()) {
    return NULL;
  }
...
static JNICALL jstring ICU_getCldrVersion(JNIEnv* env, jclass) {
  UErrorCode status = U_ZERO_ERROR;
...
static JNICALL jstring ICU_getIcuVersion(JNIEnv* env, jclass) {
    UVersionInfo icuVersion;
    u_getVersion(icuVersion);
    return versionString(env, icuVersion);
}

static JNICALL jstring ICU_getUnicodeVersion(JNIEnv* env, jclass) {
    UVersionInfo unicodeVersion;
    u_getUnicodeVersion(unicodeVersion);
    return versionString(env, unicodeVersion);
}

static JNICALL jstring ICU_getTZDataVersion(JNIEnv* env, jclass) {
  UErrorCode status = U_ZERO_ERROR;
...
static JNICALL jobject ICU_getAvailableCurrencyCodes(JNIEnv* env, jclass) {
  UErrorCode status = U_ZERO_ERROR;
...
static JNICALL jstring ICU_getBestDateTimePatternNative(JNIEnv* env, jclass, jstring javaSkeleton, jstring javaLanguageTag) {
  ScopedIcuLocale icuLocale(env, javaLanguageTag);
  if (!icuLocale.valid()) {
    return NULL;
  }
...
#else
  return env->NewString(CAST_TO_CONST_JCHAR(result.getBuffer()), result.length());
#endif
}

static JNICALL void ICU_setDefaultLocale(JNIEnv* env, jclass, jstring javaLanguageTag) {
  ScopedIcuLocale icuLocale(env, javaLanguageTag);
  if (!icuLocale.valid()) {
    return;
  }
...
static JNICALL jstring ICU_getDefaultLocale(JNIEnv* env, jclass) {

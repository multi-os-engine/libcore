...
static jint Posix_poll(JNIEnv* env, jobject, jobjectArray javaStructs, jint timeoutMs) {
    ...
    // Turn the Java android.os.StructPollfd[] into a C++ struct pollfd[].
    ...
    // Update the revents fields in the Java android.os.StructPollfd[].
    for (size_t i = 0; i < count; ++i) {
        ScopedLocalRef<jobject> javaStruct(env, env->GetObjectArrayElement(javaStructs, i));
        if (javaStruct.get() == NULL) {
            return -1;
...
static JNINativeMethod gMethods[] = {
    ...
    NATIVE_METHOD(Posix, fcntlFlock, "(Ljava/io/FileDescriptor;ILandroid/os/StructFlock;)I"),
    NATIVE_METHOD(Posix, fdatasync, "(Ljava/io/FileDescriptor;)V"),
    NATIVE_METHOD(Posix, fstat, "(Ljava/io/FileDescriptor;)Landroid/os/StructStat;"),
    NATIVE_METHOD(Posix, fstatvfs, "(Ljava/io/FileDescriptor;)Landroid/os/StructStatVfs;"),
    ...
    NATIVE_METHOD(Posix, getaddrinfo, "(Ljava/lang/String;Landroid/os/StructAddrinfo;)[Ljava/net/InetAddress;"),
    ...
    NATIVE_METHOD(Posix, getpwnam, "(Ljava/lang/String;)Landroid/os/StructPasswd;"),
    NATIVE_METHOD(Posix, getpwuid, "(I)Landroid/os/StructPasswd;"),
    ...
    NATIVE_METHOD(Posix, getsockoptLinger, "(Ljava/io/FileDescriptor;II)Landroid/os/StructLinger;"),
    NATIVE_METHOD(Posix, getsockoptTimeval, "(Ljava/io/FileDescriptor;II)Landroid/os/StructTimeval;"),
    NATIVE_METHOD(Posix, getsockoptUcred, "(Ljava/io/FileDescriptor;II)Landroid/os/StructUcred;"),
    ...
    NATIVE_METHOD(Posix, lstat, "(Ljava/lang/String;)Landroid/os/StructStat;"),
    ...
    NATIVE_METHOD(Posix, poll, "([Landroid/os/StructPollfd;I)I"),
    ...
    NATIVE_METHOD(Posix, setsockoptGroupReq, "(Ljava/io/FileDescriptor;IILandroid/os/StructGroupReq;)V"),
    NATIVE_METHOD(Posix, setsockoptGroupSourceReq, "(Ljava/io/FileDescriptor;IILandroid/os/StructGroupSourceReq;)V"),
    NATIVE_METHOD(Posix, setsockoptLinger, "(Ljava/io/FileDescriptor;IILandroid/os/StructLinger;)V"),
    NATIVE_METHOD(Posix, setsockoptTimeval, "(Ljava/io/FileDescriptor;IILandroid/os/StructTimeval;)V"),
    ...
    NATIVE_METHOD(Posix, stat, "(Ljava/lang/String;)Landroid/os/StructStat;"),
    NATIVE_METHOD(Posix, statvfs, "(Ljava/lang/String;)Landroid/os/StructStatVfs;"),
    ...
    NATIVE_METHOD(Posix, uname, "()Landroid/os/StructUtsname;"),

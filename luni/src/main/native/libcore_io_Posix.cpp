...
static bool javaNetlinkSocketAddressToSockaddr(
    ...
    return false;
#else
    static jfieldID nlFamilyFid = env->GetFieldID(
            JniConstants::netlinkSocketAddressClass, "nl_family", "I");
    static jfieldID nlPidFid = env->GetFieldID(
            JniConstants::netlinkSocketAddressClass, "nl_pid", "I");
    static jfieldID nlGroupsFid = env->GetFieldID(
            JniConstants::netlinkSocketAddressClass, "nl_groups", "I");

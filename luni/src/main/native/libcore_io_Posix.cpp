...
static bool javaPacketSocketAddressToSockaddr(
    ...
    static jfieldID protocolFid = env->GetFieldID(
            JniConstants::packetSocketAddressClass, "protocol", "S");
    static jfieldID ifindexFid = env->GetFieldID(
            JniConstants::packetSocketAddressClass, "ifindex", "I");
    static jfieldID hatypeFid = env->GetFieldID(
            JniConstants::packetSocketAddressClass, "hatype", "S");
    static jfieldID pkttypeFid = env->GetFieldID(
            JniConstants::packetSocketAddressClass, "pkttype", "B");
    static jfieldID addrFid = env->GetFieldID(
            JniConstants::packetSocketAddressClass, "addr", "[B");
...
ALOGE("javaPacketSocketAddressToSockaddr: protocol=0x%x, ifindex=%d, hatype=%d, pkttype=%d, halen=%d",
      sll->sll_protocol, sll->sll_ifindex, sll->sll_hatype, sll->sll_pkttype, sll->sll_halen);
    return true;
}

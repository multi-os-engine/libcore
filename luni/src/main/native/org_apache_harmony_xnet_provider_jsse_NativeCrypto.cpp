...
static jobjectArray NativeCrypto_get_X509_GENERAL_NAME_stack(JNIEnv* env, jclass, jint x509Ref,
        jint type) {
...
static int NativeCrypto_X509_get_notBefore(JNIEnv* env, jclass, jint x509Ref) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
    ...
    return static_cast<jint>(reinterpret_cast<uintptr_t>(notBefore));
}

static int NativeCrypto_X509_get_notAfter(JNIEnv* env, jclass, jint x509Ref) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
    ...
    return static_cast<jint>(reinterpret_cast<uintptr_t>(notAfter));
}

static int NativeCrypto_X509_cmp_time(JNIEnv*, jclass, jint asn1TimeRef, jlong timeMillis) {
    ASN1_TIME* asn1Time = reinterpret_cast<ASN1_TIME*>(static_cast<uintptr_t>(asn1TimeRef));
    JNI_TRACE("X509_cmp_time(%p, %lld)", asn1Time, timeMillis);

    time_t time = timeMillis / 1000;

    int ret = X509_cmp_time(asn1Time, &time);
    JNI_TRACE("X509_cmp_time(%p, %lld) => %d", asn1Time, timeMillis, ret);
    return ret;
}

static int NativeCrypto_X509_cmp_current_time(JNIEnv*, jclass, jint asn1TimeRef) {
    ASN1_TIME* asn1Time = reinterpret_cast<ASN1_TIME*>(static_cast<uintptr_t>(asn1TimeRef));
    JNI_TRACE("X509_cmp_current_time(%p)", asn1Time);

    int ret = X509_cmp_current_time(asn1Time);
    JNI_TRACE("X509_cmp_current_time(%p) => %d", asn1Time, ret);
    return ret;
}

static long NativeCrypto_X509_get_version(JNIEnv*, jclass, jint x509Ref) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
...
static jbyteArray NativeCrypto_X509_get_serialNumber(JNIEnv* env, jclass, jint x509Ref) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
    JNI_TRACE("X509_get_serialNumber(%p)", x509);
    return get_X509Type_serialNumber<X509>(env, x509, X509_get_serialNumber);
}

static jbyteArray NativeCrypto_X509_REVOKED_get_serialNumber(JNIEnv* env, jclass, jint x509RevokedRef) {
...
static void NativeCrypto_X509_verify(JNIEnv* env, jclass, jint x509Ref, jint pkeyRef) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
    EVP_PKEY* pkey = reinterpret_cast<EVP_PKEY*>(pkeyRef);
...
static jbyteArray NativeCrypto_get_X509_cert_info_enc(JNIEnv* env, jclass, jint x509Ref) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
    JNI_TRACE("get_X509_cert_info_enc(%p)", x509);
    return ASN1ToByteArray<X509_CINF, i2d_X509_CINF>(env, x509->cert_info);
}

static jint NativeCrypto_get_X509_ex_flags(JNIEnv* env, jclass, jint x509Ref) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
...
static jbyteArray NativeCrypto_get_X509_signature(JNIEnv* env, jclass, jint x509Ref) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
    JNI_TRACE("get_X509_signature(%p)", x509);
    return get_X509Type_signature<X509>(env, x509, get_X509_signature);
}

static jbyteArray NativeCrypto_get_X509_CRL_signature(JNIEnv* env, jclass, jint x509CrlRef) {
...
static jint NativeCrypto_X509_CRL_get0_by_cert(JNIEnv* env, jclass, jint x509crlRef, jint x509Ref) {
    ...
    return static_cast<jint>(reinterpret_cast<uintptr_t>(revoked));
}

static jint NativeCrypto_X509_CRL_get0_by_serial(JNIEnv* env, jclass, jint x509crlRef, jbyteArray serialArray) {
    X509_CRL* x509crl = reinterpret_cast<X509_CRL*>(static_cast<uintptr_t>(x509crlRef));
...
static jintArray NativeCrypto_X509_CRL_get_REVOKED(JNIEnv* env, jclass, jint x509CrlRef) {
    X509_CRL* crl = reinterpret_cast<X509_CRL*>(static_cast<uintptr_t>(x509CrlRef));
    ...
    ScopedLocalRef<jintArray> revokedArray(env, env->NewIntArray(size));
    ScopedIntArrayRW revoked(env, revokedArray.get());
    for (size_t i = 0; i < size; i++) {
        X509_REVOKED* item = reinterpret_cast<X509_REVOKED*>(sk_X509_REVOKED_value(stack, i));
        revoked[i] = static_cast<jint>(reinterpret_cast<uintptr_t>(X509_REVOKED_dup(item)));
    }
...
static jbyteArray NativeCrypto_i2d_X509_CRL(JNIEnv* env, jclass, jint x509CrlRef) {
    X509_CRL* crl = reinterpret_cast<X509_CRL*>(static_cast<uintptr_t>(x509CrlRef));
    JNI_TRACE("i2d_X509_CRL(%p)", crl);
    return ASN1ToByteArray<X509_CRL, i2d_X509_CRL>(env, crl);
}

static void NativeCrypto_X509_CRL_free(JNIEnv* env, jclass, jint x509CrlRef) {
    X509_CRL* crl = reinterpret_cast<X509_CRL*>(static_cast<uintptr_t>(x509CrlRef));
...
static void NativeCrypto_X509_CRL_print(JNIEnv* env, jclass, jint bioRef, jint x509CrlRef) {
    ...
    if (bio == NULL) {
        ...
        JNI_TRACE("X509_print_ex(%p, %p, %ld, %ld) => bio == null", bio, crl);
        return;
    }

    if (crl == NULL) {
        jniThrowNullPointerException(env, "crl == null");
        JNI_TRACE("X509_print_ex(%p, %p) => crl == null", bio, crl);
        return;
    }
...
static jstring NativeCrypto_get_X509_CRL_sig_alg_oid(JNIEnv* env, jclass, jint x509CrlRef) {
    X509_CRL* crl = reinterpret_cast<X509_CRL*>(static_cast<uintptr_t>(x509CrlRef));
...
static jbyteArray NativeCrypto_X509_CRL_get_issuer_name(JNIEnv* env, jclass, jint x509CrlRef) {
    X509_CRL* crl = reinterpret_cast<X509_CRL*>(static_cast<uintptr_t>(x509CrlRef));
    JNI_TRACE("X509_CRL_get_issuer_name(%p)", crl);
    return ASN1ToByteArray<X509_NAME, i2d_X509_NAME>(env, X509_CRL_get_issuer(crl));
}

static long NativeCrypto_X509_CRL_get_version(JNIEnv*, jclass, jint x509CrlRef) {
    X509_CRL* crl = reinterpret_cast<X509_CRL*>(static_cast<uintptr_t>(x509CrlRef));
...
static jint NativeCrypto_X509_CRL_get_ext(JNIEnv* env, jclass, jint x509CrlRef, jstring oid) {
    X509_CRL* crl = reinterpret_cast<X509_CRL*>(static_cast<uintptr_t>(x509CrlRef));
    ...
    return static_cast<jint>(reinterpret_cast<uintptr_t>(ext));
}

static jint NativeCrypto_X509_REVOKED_get_ext(JNIEnv* env, jclass, jint x509RevokedRef,
        jstring oid) {
    X509_REVOKED* revoked = reinterpret_cast<X509_REVOKED*>(static_cast<uintptr_t>(x509RevokedRef));
...
static jint NativeCrypto_X509_REVOKED_dup(JNIEnv* env, jclass, jint x509RevokedRef) {
    X509_REVOKED* revoked = reinterpret_cast<X509_REVOKED*>(static_cast<uintptr_t>(x509RevokedRef));
    ...
    return static_cast<jint>(reinterpret_cast<uintptr_t>(dup));
}

static jint NativeCrypto_get_X509_REVOKED_revocationDate(JNIEnv* env, jclass, jint x509RevokedRef) {
    X509_REVOKED* revoked = reinterpret_cast<X509_REVOKED*>(static_cast<uintptr_t>(x509RevokedRef));
    ...
    return static_cast<jint>(reinterpret_cast<uintptr_t>(revoked->revocationDate));
}

static jbyteArray NativeCrypto_get_X509_CRL_crl_enc(JNIEnv* env, jclass, jint x509CrlRef) {
    X509_CRL* crl = reinterpret_cast<X509_CRL*>(static_cast<uintptr_t>(x509CrlRef));
    JNI_TRACE("get_X509_CRL_crl_enc(%p)", crl);
    return ASN1ToByteArray<X509_CRL_INFO, i2d_X509_CRL_INFO>(env, crl->crl);
}

static jint NativeCrypto_X509_CRL_get_lastUpdate(JNIEnv* env, jclass, jint x509CrlRef) {
    X509_CRL* crl = reinterpret_cast<X509_CRL*>(static_cast<uintptr_t>(x509CrlRef));
    ...
    return static_cast<jint>(reinterpret_cast<uintptr_t>(lastUpdate));
}

static jint NativeCrypto_X509_CRL_get_nextUpdate(JNIEnv* env, jclass, jint x509CrlRef) {
    X509_CRL* crl = reinterpret_cast<X509_CRL*>(static_cast<uintptr_t>(x509CrlRef));
    ...
    return static_cast<jint>(reinterpret_cast<uintptr_t>(nextUpdate));
}

static jbyteArray NativeCrypto_i2d_X509_REVOKED(JNIEnv* env, jclass, jint x509RevokedRef) {
...
static jint NativeCrypto_X509_supported_extension(JNIEnv* env, jclass, jint x509ExtensionRef) {
...
static void NativeCrypto_ASN1_TIME_to_Calendar(JNIEnv* env, jclass, jint asn1TimeRef, jobject calendar) {
    ASN1_TIME* asn1Time = reinterpret_cast<ASN1_TIME*>(static_cast<uintptr_t>(asn1TimeRef));
...
static jstring NativeCrypto_X509_NAME_print_ex(JNIEnv* env, jclass, jint x509NameRef, jlong jflags) {
...
static jint d2i_ASN1Object_to_jint(JNIEnv* env, jint bioRef) {
    BIO* bio = reinterpret_cast<BIO*>(static_cast<uintptr_t>(bioRef));
    JNI_TRACE("d2i_ASN1Object_to_jint(%p)", bio);
    ...
    if (x == NULL) {
        throwExceptionIfNecessary(env, "d2i_ASN1Object_to_jint");
        return 0;
    }
...
static jint NativeCrypto_d2i_X509_CRL_bio(JNIEnv* env, jclass, jint bioRef) {
    return d2i_ASN1Object_to_jint<X509_CRL, d2i_X509_CRL_bio>(env, bioRef);
}

static jint NativeCrypto_d2i_X509_bio(JNIEnv* env, jclass, jint bioRef) {
    return d2i_ASN1Object_to_jint<X509, d2i_X509_bio>(env, bioRef);
}

static jbyteArray NativeCrypto_i2d_X509(JNIEnv* env, jclass, jint x509Ref) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
...
static jint PEM_ASN1Object_to_jint(JNIEnv* env, jint bioRef) {
    BIO* bio = reinterpret_cast<BIO*>(static_cast<uintptr_t>(bioRef));
    JNI_TRACE("PEM_ASN1Object_to_jint(%p)", bio);

    if (bio == NULL) {
        jniThrowNullPointerException(env, "bio == null");
        JNI_TRACE("PEM_read_bio_X509_AUX(%p) => bio == null", bio);
        return 0;
    }

    T* x = PEM_read_func(bio, NULL, NULL, NULL);
    if (x == NULL) {
        throwExceptionIfNecessary(env, "PEM_ASN1Object_to_jint");
        JNI_TRACE("PEM_ASN1Object_to_jint(%p) => threw exception", bio);
        return 0;
    }

    JNI_TRACE("PEM_ASN1Object_to_jint(%p) => %p", bio, x);
    return static_cast<jint>(reinterpret_cast<uintptr_t>(x));
}

static jint NativeCrypto_PEM_read_bio_X509_AUX(JNIEnv* env, jclass, jint bioRef) {
    JNI_TRACE("PEM_read_bio_X509_AUX(0x%x)", bioRef);
    return PEM_ASN1Object_to_jint<X509, PEM_read_bio_X509_AUX>(env, bioRef);
}

static jint NativeCrypto_PEM_read_bio_X509_CRL(JNIEnv* env, jclass, jint bioRef) {
    JNI_TRACE("PEM_read_bio_X509_CRL(0x%x)", bioRef);
    return PEM_ASN1Object_to_jint<X509_CRL, PEM_read_bio_X509_CRL>(env, bioRef);
}
...
static jintArray PKCS7_to_ItemArray(JNIEnv* env, T_stack* stack, T* (*dup_func)(T*))
{
    if (stack == NULL) {
        return NULL;
    }

    ScopedLocalRef<jintArray> ref_array(env, NULL);
    size_t size = sk_num(reinterpret_cast<_STACK*>(stack));
    ref_array.reset(env->NewIntArray(size));
    ScopedIntArrayRW items(env, ref_array.get());
    for (size_t i = 0; i < size; i++) {
        T* item = reinterpret_cast<T*>(sk_value(reinterpret_cast<_STACK*>(stack), i));
        items[i] = static_cast<jint>(reinterpret_cast<uintptr_t>(dup_func(item)));
    }
...
static jintArray NativeCrypto_PEM_read_bio_PKCS7(JNIEnv* env, jclass, jint bioRef, jint which) {
    BIO* bio = reinterpret_cast<BIO*>(static_cast<uintptr_t>(bioRef));
...
static jintArray NativeCrypto_d2i_PKCS7_bio(JNIEnv* env, jclass, jint bioRef, jint which) {
    BIO* bio = reinterpret_cast<BIO*>(static_cast<uintptr_t>(bioRef));
...
static void NativeCrypto_X509_free(JNIEnv* env, jclass, jint x509Ref) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
...
static jbyteArray NativeCrypto_X509_get_issuer_name(JNIEnv* env, jclass, jint x509Ref) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
    JNI_TRACE("X509_get_issuer_name(%p)", x509);
    return ASN1ToByteArray<X509_NAME, i2d_X509_NAME>(env, X509_get_issuer_name(x509));
}

static jbyteArray NativeCrypto_X509_get_subject_name(JNIEnv* env, jclass, jint x509Ref) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
...
static jstring NativeCrypto_get_X509_sig_alg_oid(JNIEnv* env, jclass, jint x509Ref) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
...
static jbooleanArray NativeCrypto_get_X509_ex_kusage(JNIEnv* env, jclass, jint x509Ref) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
    ...
    ScopedLocalRef<jbooleanArray> keyUsage(env, env->NewBooleanArray(size));
    if (keyUsage.get() == NULL) {
        return NULL;
    }

    ScopedBooleanArrayRW keyUsageBits(env, keyUsage.get());
    for (size_t i = 0; i < keyUsageBits.size(); i++) {
        keyUsageBits[i] = ASN1_BIT_STRING_get_bit(bitStr.get(), i);
    }

    JNI_TRACE("get_X509_ex_kusage(%p) => success (%d entries)", x509, keyUsageBits.size());
    return keyUsage.release();
}

static jobjectArray NativeCrypto_get_X509_ex_xkusage(JNIEnv* env, jclass, jint x509Ref) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
...
static jint NativeCrypto_X509_check_ca(JNIEnv* env, jclass, jint x509Ref) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
...
static jint NativeCrypto_get_X509_ex_pathlen(JNIEnv* env, jclass, jint x509Ref) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
...
static jbyteArray NativeCrypto_X509_get_ext_oid(JNIEnv* env, jclass, jint x509Ref,
        jstring oidString) {
    X509* x509 = reinterpret_cast<X509*>(static_cast<uintptr_t>(x509Ref));
...
static jbyteArray NativeCrypto_X509_CRL_get_ext_oid(JNIEnv* env, jclass, jint x509CrlRef,
        jstring oidString) {
    X509_CRL* crl = reinterpret_cast<X509_CRL*>(static_cast<uintptr_t>(x509CrlRef));
...
static jbyteArray NativeCrypto_X509_REVOKED_get_ext_oid(JNIEnv* env, jclass, jint x509RevokedRef,
        jstring oidString) {
    X509_REVOKED* revoked = reinterpret_cast<X509_REVOKED*>(static_cast<uintptr_t>(x509RevokedRef));
...
static jobjectArray get_X509Type_ext_oids(JNIEnv* env, jint x509Ref,
        jint critical) {
...
static jobjectArray NativeCrypto_get_X509_ext_oids(JNIEnv* env, jclass, jint x509Ref,
        jint critical) {
    JNI_TRACE("get_X509_ext_oids(0x%x, %d)", x509Ref, critical);
    return get_X509Type_ext_oids<X509, X509_get_ext_by_critical, X509_get_ext>(env, x509Ref,
            critical);
}

static jobjectArray NativeCrypto_get_X509_CRL_ext_oids(JNIEnv* env, jclass, jint x509CrlRef,
        jint critical) {
    JNI_TRACE("get_X509_CRL_ext_oids(0x%x, %d)", x509CrlRef, critical);
    return get_X509Type_ext_oids<X509_CRL, X509_CRL_get_ext_by_critical, X509_CRL_get_ext>(env,
            x509CrlRef, critical);
}

static jobjectArray NativeCrypto_get_X509_REVOKED_ext_oids(JNIEnv* env, jclass, jint x509RevokedRef,
        jint critical) {
    JNI_TRACE("get_X509_CRL_ext_oids(0x%x, %d)", x509RevokedRef, critical);
...
static jobjectArray getPrincipalBytes(JNIEnv* env, const STACK_OF(X509_NAME)* names)
{
    ...
    for (int i = 0; i < count; i++) {
        ...
        ScopedLocalRef<jbyteArray> byteArray(env, ASN1ToByteArray<X509_NAME, i2d_X509_NAME>(env,principal));
        if (byteArray.get() == NULL) {
            return NULL;
        }
...
static JNINativeMethod sNativeCryptoMethods[] = {
    ...
    NATIVE_METHOD(NativeCrypto, X509_NAME_print_ex, "(IJ)Ljava/lang/String;"),
    NATIVE_METHOD(NativeCrypto, d2i_X509_bio, "(I)I"),
    NATIVE_METHOD(NativeCrypto, i2d_X509, "(I)[B"),
    NATIVE_METHOD(NativeCrypto, PEM_read_bio_X509_AUX, "(I)I"),
    NATIVE_METHOD(NativeCrypto, PEM_read_bio_PKCS7, "(II)[I"),
    NATIVE_METHOD(NativeCrypto, d2i_PKCS7_bio, "(II)[I"),
    NATIVE_METHOD(NativeCrypto, X509_free, "(I)V"),
    NATIVE_METHOD(NativeCrypto, X509_print_ex, "(IIJJ)V"),
    NATIVE_METHOD(NativeCrypto, X509_get_pubkey, "(I)I"),
    NATIVE_METHOD(NativeCrypto, X509_get_issuer_name, "(I)[B"),
    NATIVE_METHOD(NativeCrypto, X509_get_subject_name, "(I)[B"),
    NATIVE_METHOD(NativeCrypto, get_X509_pubkey_oid, "(I)Ljava/lang/String;"),
    NATIVE_METHOD(NativeCrypto, get_X509_sig_alg_oid, "(I)Ljava/lang/String;"),
    NATIVE_METHOD(NativeCrypto, get_X509_ex_kusage, "(I)[Z"),
    NATIVE_METHOD(NativeCrypto, get_X509_ex_xkusage, "(I)[Ljava/lang/String;"),
    NATIVE_METHOD(NativeCrypto, X509_check_ca, "(I)I"),
    NATIVE_METHOD(NativeCrypto, get_X509_ex_pathlen, "(I)I"),
    NATIVE_METHOD(NativeCrypto, X509_get_ext_oid, "(ILjava/lang/String;)[B"),
    NATIVE_METHOD(NativeCrypto, X509_CRL_get_ext_oid, "(ILjava/lang/String;)[B"),
    NATIVE_METHOD(NativeCrypto, get_X509_CRL_crl_enc, "(I)[B"),
    NATIVE_METHOD(NativeCrypto, X509_CRL_get_lastUpdate, "(I)I"),
    NATIVE_METHOD(NativeCrypto, X509_CRL_get_nextUpdate, "(I)I"),
    NATIVE_METHOD(NativeCrypto, X509_REVOKED_get_ext_oid, "(ILjava/lang/String;)[B"),
    NATIVE_METHOD(NativeCrypto, X509_REVOKED_get_serialNumber, "(I)[B"),
    NATIVE_METHOD(NativeCrypto, get_X509_REVOKED_revocationDate, "(I)I"),
    NATIVE_METHOD(NativeCrypto, get_X509_ext_oids, "(II)[Ljava/lang/String;"),
    NATIVE_METHOD(NativeCrypto, get_X509_CRL_ext_oids, "(II)[Ljava/lang/String;"),
    NATIVE_METHOD(NativeCrypto, get_X509_REVOKED_ext_oids, "(II)[Ljava/lang/String;"),
    NATIVE_METHOD(NativeCrypto, get_X509_GENERAL_NAME_stack, "(II)[[Ljava/lang/Object;"),
    NATIVE_METHOD(NativeCrypto, X509_get_notBefore, "(I)I"),
    NATIVE_METHOD(NativeCrypto, X509_get_notAfter, "(I)I"),
    NATIVE_METHOD(NativeCrypto, X509_cmp_time, "(IJ)I"),
    NATIVE_METHOD(NativeCrypto, X509_cmp_current_time, "(I)I"),
    NATIVE_METHOD(NativeCrypto, X509_get_version, "(I)J"),
    NATIVE_METHOD(NativeCrypto, X509_get_serialNumber, "(I)[B"),
    NATIVE_METHOD(NativeCrypto, X509_verify, "(II)V"),
    NATIVE_METHOD(NativeCrypto, get_X509_cert_info_enc, "(I)[B"),
    NATIVE_METHOD(NativeCrypto, get_X509_signature, "(I)[B"),
    NATIVE_METHOD(NativeCrypto, get_X509_CRL_signature, "(I)[B"),
    NATIVE_METHOD(NativeCrypto, get_X509_ex_flags, "(I)I"),
    NATIVE_METHOD(NativeCrypto, d2i_X509_CRL_bio, "(I)I"),
    NATIVE_METHOD(NativeCrypto, PEM_read_bio_X509_CRL, "(I)I"),
    NATIVE_METHOD(NativeCrypto, X509_CRL_get0_by_cert, "(II)I"),
    NATIVE_METHOD(NativeCrypto, X509_CRL_get0_by_serial, "(I[B)I"),
    NATIVE_METHOD(NativeCrypto, X509_CRL_get_REVOKED, "(I)[I"),
    NATIVE_METHOD(NativeCrypto, i2d_X509_CRL, "(I)[B"),
    NATIVE_METHOD(NativeCrypto, X509_CRL_free, "(I)V"),
    NATIVE_METHOD(NativeCrypto, X509_CRL_print, "(II)V"),
    NATIVE_METHOD(NativeCrypto, get_X509_CRL_sig_alg_oid, "(I)Ljava/lang/String;"),
    NATIVE_METHOD(NativeCrypto, X509_CRL_get_issuer_name, "(I)[B"),
    NATIVE_METHOD(NativeCrypto, X509_CRL_get_version, "(I)J"),
    NATIVE_METHOD(NativeCrypto, X509_CRL_get_ext, "(ILjava/lang/String;)I"),
    NATIVE_METHOD(NativeCrypto, X509_REVOKED_get_ext, "(ILjava/lang/String;)I"),
    NATIVE_METHOD(NativeCrypto, X509_REVOKED_dup, "(I)I"),
    NATIVE_METHOD(NativeCrypto, i2d_X509_REVOKED, "(I)[B"),
    NATIVE_METHOD(NativeCrypto, X509_supported_extension, "(I)I"),
    NATIVE_METHOD(NativeCrypto, ASN1_TIME_to_Calendar, "(ILjava/util/Calendar;)V"),

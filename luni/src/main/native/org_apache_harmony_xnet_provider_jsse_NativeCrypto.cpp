...
static int NativeCrypto_X509_cmp_time(JNIEnv*, jclass, jlong asn1TimeRef, jlong timeMillis) {
...
static int NativeCrypto_X509_cmp_current_time(JNIEnv*, jclass, jlong asn1TimeRef) {
    ASN1_TIME* asn1Time = reinterpret_cast<ASN1_TIME*>(static_cast<uintptr_t>(asn1TimeRef));
...
static jlong NativeCrypto_PEM_read_bio_X509_AUX(JNIEnv* env, jclass, jlong bioRef) {
    JNI_TRACE("PEM_read_bio_X509_AUX(0x%x)", bioRef);
    return PEM_ASN1Object_to_jlong<X509, PEM_read_bio_X509_AUX>(env, bioRef);
}
...
static JNINativeMethod sNativeCryptoMethods[] = {
    ...
    NATIVE_METHOD(NativeCrypto, PEM_read_bio_X509_AUX, "(J)J"),
    ...
    NATIVE_METHOD(NativeCrypto, X509_cmp_time, "(JJ)I"),
    NATIVE_METHOD(NativeCrypto, X509_cmp_current_time, "(J)I"),

...
static jobjectArray NativeCrypto_EC_GROUP_get_curve(JNIEnv* env, jclass, jint type, jint groupRef)
{
    const EC_GROUP* group = reinterpret_cast<const EC_GROUP*>(groupRef);
    JNI_TRACE("EC_GROUP_get_curve(%d, %p)", type, group);
    ...
    JNI_TRACE("EC_GROUP_get_curve(%d, %p) => %p", type, group, joa);
    return joa;
}
...
static JNINativeMethod sNativeCryptoMethods[] = {
    ...
    NATIVE_METHOD(NativeCrypto, EC_GROUP_get_curve, "(II)[[B"),

...
static JNICALL jlong RelativeDateTimeFormatter_createRelativeDateTimeFormatter(JNIEnv* env, jclass,
...
static JNICALL void RelativeDateTimeFormatter_destroyRelativeDateTimeFormatter(JNIEnv*, jclass,
    jlong formatterAddress) {
  delete reinterpret_cast<icu::RelativeDateTimeFormatter*>(static_cast<uintptr_t>(formatterAddress));
}

static JNICALL jstring RelativeDateTimeFormatter_formatWithRelativeUnit(JNIEnv* env, jclass,
...
static JNICALL jstring RelativeDateTimeFormatter_formatWithAbsoluteUnit(JNIEnv* env, jclass,
...
static JNICALL jstring RelativeDateTimeFormatter_combineDateAndTime(JNIEnv* env, jclass,
...
void register_libcore_icu_RelativeDateTimeFormatter(JNIEnv* ) {
}

...
// Native code to call RelativeDateTimeFormatter::RelativeDateTimeFormatter(
//   const Locale&, NumberFormat*, UDateRelativeDateTimeFormatterStyle,
//   UDisplayContext, UErrorCode&) in icu4c to create an instance of
// RelativeDateTimeFormatter. 'javaLocaleName' is checked to be a valid icu
// locale.
//
// 'style' is casted to UDateRelativeDateTimeFormatterStyle which is
// defined in external/icu/icu4c/source/i18n/unicode/reldatefmt.h.
//
// 'capitalizationContext' is casted to UDisplayContext defined in
// external/icu/icu4c/source/i18n/unicode/udisplaycontext.h.
...
// Destroy the formatter instance.
...
// Native code to call icu4c's RelativeDateTimeFormatter::format(double,
//   UDateDirection, UDateRelativeUnit, UnicodeString&, UErrorCode&) with the
// given formatter instance in 'formatterAddress'. 'quantity' is converted to
// double to match icu's API. 'direction' and 'unit' are casted to
// UDateDirection and UDateRelativeUnit respectively, which are defined in
...
// Native code to call icu4c's RelativeDateTimeFormatter::format(
//   UDateDirection, UDateAbsoluteUnit, UnicodeString&, UErrorCode&) with the
// given formatter instance in 'formatterAddress'. 'direction' and 'unit' are
// casted to UDateDirection and UDateRelativeUnit respectively.
...
// Native code to call icu4c's RelativeDateTimeFormatter::combineDateAndTime(
//   const UnicodeString&, const UnicodeString&, UnicodeString&, UErrorCode)
// with the given formatter instance in 'formatterAddress'.
// 'relativeDateString0' and 'timeString0' are checked to be valid Java
// unicode strings.

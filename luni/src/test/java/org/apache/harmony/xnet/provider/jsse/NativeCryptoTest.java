...
public class NativeCryptoTest extends TestCase {
    ...
    public void test_EC_GROUP_GFp_prime256v1() throws Exception {
        ...
        try {
            ...
            assertEquals(NativeCrypto.EC_CURVE_GFP, NativeCrypto.get_EC_GROUP_type(group1));
            ...
            group2 = NativeCrypto.EC_GROUP_new_curve(NativeCrypto.EC_CURVE_GFP, p.toByteArray(),
                    a.toByteArray(), b.toByteArray());
            assertEquals(NativeCrypto.EC_CURVE_GFP, NativeCrypto.get_EC_GROUP_type(group2));

            point2 = NativeCrypto.EC_POINT_new(group2);

            NativeCrypto.EC_POINT_set_affine_coordinates(NativeCrypto.EC_CURVE_GFP, group2, point2,
            ...
            byte[][] xy = NativeCrypto.EC_POINT_get_affine_coordinates(NativeCrypto.EC_CURVE_GFP,
                    group2, point2);
    ...
    private void check_EC_GROUP(int type, String name, String pStr, String aStr, String bStr,
        ...
        try {
            ...
            NativeCrypto.EC_POINT_set_affine_coordinates(type, group2, point2, x.toByteArray(),
                    y.toByteArray());
            ...
            byte[][] xy = NativeCrypto.EC_POINT_get_affine_coordinates(type, group2, point2);
            assertEquals(2, xy.length);

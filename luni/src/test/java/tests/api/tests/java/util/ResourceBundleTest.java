...
public class ResourceBundleTest extends junit.framework.TestCase {
    ...
    /**
     * {@link java.util.ResourceBundle#getBundle(String, Locale, java.util.ResourceBundle.Control)}
     * @since 1.6
     */
    @SuppressWarnings("nls")
    ...
    /**
     * {@link java.util.ResourceBundle#getBundle(String, Locale, ClassLoader, java.util.ResourceBundle.Control)}
     * @since 1.6
     */
    @SuppressWarnings("nls")
    ...
    /**
     * {@link java.util.ResourceBundle#clearCache()}
     * @since 1.6
     */
    @SuppressWarnings("nls")
    ...
    /**
     * @throws IOException
     * {@link java.util.ResourceBundle#clearCache(ClassLoader)}
     * @since 1.6
     */
    @SuppressWarnings("nls")
    ...
    /**
     * {@link java.util.ResourceBundle#containsKey(String)}
     * @since 1.6
     */
    @SuppressWarnings("nls")
    ...
    /**
     * {@link java.util.ResourceBundle#handleKeySet()}
     * @since 1.6
     */
    @SuppressWarnings("nls")

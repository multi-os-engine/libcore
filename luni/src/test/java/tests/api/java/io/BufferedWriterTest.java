...
public class BufferedWriterTest extends junit.framework.TestCase {
    ...
    public void test_close() throws IOException {
        ...
        assertTrue("Write after close", !sw.toString().equals(INPUT));
    ...
    public void test_writeLjava_lang_StringII() throws Exception {
        bw.write(INPUT);
        bw.flush();
        assertTrue("Incorrect string written", sw.toString().equals(INPUT));
    }
    ...
    public void test_write_LStringII_Exception() throws IOException {
        ...
        bWriter.write(INPUT, 0, 0);
        bWriter.write(INPUT, INPUT.length(), 0);
        bWriter.write(INPUT, INPUT.length() + 1, 0);

        try {
            bWriter.write(INPUT, INPUT.length() + 1, 1);

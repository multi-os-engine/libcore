...
public class ByteArrayOutputStreamTest extends TestCase {
    ...
    public void test_reset() {
        ...
        bos.write(INPUT.getBytes(), 0, 100);
        bos.reset();
    ...
    public void test_toByteArray() {
        ...
        bos = new java.io.ByteArrayOutputStream();
        bos.write(INPUT.getBytes(), 0, INPUT.length());
    ...
    public void test_toStringLjava_lang_String() throws IOException {
        ...
        bos.write(INPUT.getBytes("UTF-8"), 0, INPUT.length());
    ...
    public void test_toStringI() {
        ...
        assertTrue("Returned incorrect String",
                bos.toString(5).length() == INPUT.length());
    }
    ...
    public void test_write$BII() {
        ...
        assertTrue("Wrote incorrect bytes",
                new String(result, 0, result.length).equals(INPUT
                        .substring(0, 100)));
    }

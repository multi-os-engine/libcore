...
public class TimerTest extends TestCase {
    ...
    private void awaitRun(TimerTestTask task) throws InterruptedException {
        while (task.wasRun() == 0) {
            Thread.sleep(150);
        }
    }
     ...
     */
    public void test_ConstructorZ() throws InterruptedException {
        Timer t = null;
        try {
     ...
     */
    public void test_ConstructorSZ() throws InterruptedException {
        Timer t = null;
        try {
            // Ensure a task is run
     ...
     */
    public void test_ConstructorS() throws InterruptedException {
        Timer t = null;
        try {
            // Ensure a task is run
     ...
     */
    public void test_scheduleLjava_util_TimerTaskLjava_util_Date() throws InterruptedException {
        Timer t = null;
        try {
     ...
     */
    public void test_scheduleLjava_util_TimerTaskJ() throws InterruptedException {
        Timer t = null;
        try {
            // Ensure a Timer throws an IllegalStateException after cancelled
            t = new Timer();
     ...
     */
    public void test_scheduleLjava_util_TimerTaskJJ() throws InterruptedException {
        Timer t = null;
        try {
            // Ensure a Timer throws an IllegalStateException after cancelled
            t = new Timer();
     ...
     *        long)
     */
    public void test_scheduleLjava_util_TimerTaskLjava_util_DateJ() throws InterruptedException {
        Timer t = null;
        try {
            // Ensure a Timer throws an IllegalStateException after cancelled
            t = new Timer();
     ...
     *        long)
     */
    public void test_scheduleAtFixedRateLjava_util_TimerTaskJJ() throws InterruptedException {
        Timer t = null;
        try {
            // Ensure a Timer throws an IllegalStateException after cancelled
            t = new Timer();

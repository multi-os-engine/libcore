...
public class CertificateRevocationExceptionTest extends TestCase implements SerializableAssert {
    private CertificateRevokedException getTestException() {
        ...
        // REASON_CODE
        extensions.put("2.5.29.21", getTestExtension());
    ...
    private Extension getTestExtension() {
    ...
    private Extension getInvalidityExtension() {
        // 0x0d 31 30 30 31 30 31 30 38 33 30 30 30 5a
        return new Extension() {
            @Override
            public String getId() {
                return "2.5.29.24";
    ...
    public void testGetExtensions() throws Exception {
        ...
        try {
            extensions.put("2.2.2.2", getTestExtension());
            fail();
    ...
    public void testGetRevocationDate() throws Exception {
        ...
        Date secondDate = exception.getRevocationDate();
    ...
    public void testGetInvalidityDate() throws Exception {
        ...
        Date secondDate = exception.getInvalidityDate();
        assertNotSame(firstDate, secondDate);

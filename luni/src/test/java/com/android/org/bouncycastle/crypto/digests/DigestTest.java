...
public class DigestTest extends TestCase {
    ...
    public void doTestMessageDigest(Digest oldDigest, Digest newDigest) {
        ...
        StatValues oldTime = new StatValues();
        StatValues newTime = new StatValues();
        ...
        System.out.println("Time for " + ITERATIONS + " x old hash processing: " + oldTime.toString());
        System.out.println("Time for " + ITERATIONS + " x new hash processing: " + newTime.toString());

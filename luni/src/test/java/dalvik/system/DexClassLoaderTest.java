...
public class DexClassLoaderTest extends TestCase {
    ...
    public void testDexThenPathClassLoader() throws Exception {
      ...
      // This assertion should be sufficient to ensure that a PathClassLoader
      // provided with the dex location will find and use the optimized code,
      // which is why we don't actually instantiate a PathClassLoader for this
      // test.

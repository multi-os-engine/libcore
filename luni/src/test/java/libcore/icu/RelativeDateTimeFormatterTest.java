...
public class RelativeDateTimeFormatterTest extends junit.framework.TestCase {
  ...
  public void test_getRelativeDateTimeStringItalian() throws Exception {
    ...
    long time = base - 5 * SECOND_IN_MILLIS;
    android.icu.util.TimeZone icuTimeZone = FormatUtils.icuTimeZone(tz);
    ULocale icuLocale = ULocale.forLocale(it_IT);
    String timeClause = DateIntervalFormat.formatDateRange(icuLocale, icuTimeZone, time, time, FormatUtils.FORMAT_SHOW_TIME);

...
public class RelativeDateTimeFormatterTest extends junit.framework.TestCase {
  ...
  public void test_getRelativeTimeSpanString() throws Exception {
    ...
    test_getRelativeTimeSpanString_helper(30 * WEEK_IN_MILLIS, MINUTE_IN_MILLIS, "July 10, 2014",
                                          "September 3");
    test_getRelativeTimeSpanString_helper(5 * YEAR_IN_MILLIS, MINUTE_IN_MILLIS,
  ...
  public void test_getRelativeTimeSpanStringAbbrev() throws Exception {
    ...
    test_getRelativeTimeSpanString_helper(5 * YEAR_IN_MILLIS, MINUTE_IN_MILLIS, flags,
                                          "February 6, 2010", "February 4, 2020");
  ...
  public void test_getRelativeTimeSpanStringGerman() throws Exception {
    ...
    assertEquals("vor 42 Minuten",
      getRelativeTimeSpanString(de_DE, null, now - 42 * MINUTE_IN_MILLIS, now,
                                MINUTE_IN_MILLIS, 0));
    // in 42 minutes
    ...
    assertEquals("Gestern",
                 getRelativeTimeSpanString(de_DE, null, now - DAY_IN_MILLIS, now,
                                           DAY_IN_MILLIS, 0));
    // the day before yesterday
    assertEquals("Vorgestern",
                 getRelativeTimeSpanString(de_DE, null, now - 2 * DAY_IN_MILLIS, now,
                                           DAY_IN_MILLIS, 0));
    // tomorrow
    assertEquals("Morgen",
                 getRelativeTimeSpanString(de_DE, null, now + DAY_IN_MILLIS, now,
  ...
  public void test_getRelativeTimeSpanStringFrench() throws Exception {
    ...
    assertEquals("il y a 42 minutes",
                 getRelativeTimeSpanString(fr_FR, null, now - (42 * MINUTE_IN_MILLIS), now,
                                           MINUTE_IN_MILLIS, 0));
    // in 42 minutes
    ...
    // yesterday
    assertEquals("Hier",
                 getRelativeTimeSpanString(fr_FR, null, now - DAY_IN_MILLIS, now,
                                           DAY_IN_MILLIS, 0));
    // the day before yesterday
    assertEquals("Avant-hier",
                 getRelativeTimeSpanString(fr_FR, null, now - 2 * DAY_IN_MILLIS, now,
                                           DAY_IN_MILLIS, 0));
    // tomorrow
    assertEquals("Demain",
                 getRelativeTimeSpanString(fr_FR, null, now + DAY_IN_MILLIS, now,

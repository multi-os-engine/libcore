...
public class X509CertificateNistPkitsTest extends TestCase {
    ...
    public void testBasicCertificateRevocationTests_Invalidpre2000CRLnextUpdateTest12() throws Exception {
        ...
        String[] certs = {
                "Invalidpre2000CRLnextUpdateTest12EESeetheintroductiontoSection4.4formoreinformation..crt",
    ...
    public void testBasicCertificateRevocationTests_ValidSeparateCertificateandCRLKeysTest19() throws Exception {
        ...
        String[] crls = {
                "TrustAnchorRootCRL.crl",
                "SeparateCertificateandCRLKeysCRLSigningCert.crl",
    ...
    public void testBasicCertificateRevocationTests_InvalidSeparateCertificateandCRLKeysTest21() throws Exception {
        ...
        String[] crls = {
                "TrustAnchorRootCRL.crl",
                "SeparateCertificateandCRLKeysCA2CRLSigningCert.crl",
    ...
    // TODO: skipping sections 4.8 and 4.9

    /** NIST PKITS test 4.9.1 */
    public void testKeyUsage_ValidRequireExplicitPolicyTest1() throws Exception {
        String trustAnchor = "TrustAnchorRootCertificate.crt";
    ...
    /** NIST PKITS test 4.9.2 */
    public void testKeyUsage_ValidRequireExplicitPolicyTest2() throws Exception {
        String trustAnchor = "TrustAnchorRootCertificate.crt";
    ...
    /** NIST PKITS test 4.9.3 */
    public void testKeyUsage_InvalidRequireExplicitPolicyTest3() throws Exception {
        String trustAnchor = "TrustAnchorRootCertificate.crt";
    ...
    /** NIST PKITS test 4.9.4 */
    public void testKeyUsage_ValidRequireExplicitPolicyTest4() throws Exception {
        String trustAnchor = "TrustAnchorRootCertificate.crt";
    ...
    /** NIST PKITS test 4.9.5 */
    public void testKeyUsage_InvalidRequireExplicitPolicyTest5() throws Exception {
        String trustAnchor = "TrustAnchorRootCertificate.crt";
    ...
    /** NIST PKITS test 4.9.6 */
    public void testKeyUsage_ValidSelfIssuedrequireExplicitPolicyTest6() throws Exception {
        String trustAnchor = "TrustAnchorRootCertificate.crt";
    ...
    /** NIST PKITS test 4.9.7 */
    public void testKeyUsage_InvalidSelfIssuedrequireExplicitPolicyTest7() throws Exception {
        String trustAnchor = "TrustAnchorRootCertificate.crt";
    ...
    /** NIST PKITS test 4.9.8 */
    public void testKeyUsage_InvalidSelfIssuedrequireExplicitPolicyTest8() throws Exception {
        String trustAnchor = "TrustAnchorRootCertificate.crt";
    ...
    // TODO: skipping sections 4.10, 4.11, and 4.12

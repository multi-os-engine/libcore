...
public class SignatureTest extends TestCase {
    ...
    private KeyPair keyPair(String sigAlgorithm, String providerName) throws Exception {
        ...
        // BouncyCastle is only compatible with its own EC keys.
        if (providerName.equals("BC") && "EC".equals(kpAlgorithm)) {
            return KeyPairGenerator.getInstance(kpAlgorithm, providerName).generateKeyPair();
        }

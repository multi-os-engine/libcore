...
public class HashMapTest extends junit.framework.TestCase {
  ...
  public void test_getOrDefault() {
    MapDefaultMethodTester.test_getOrDefault(new HashMap<>());
  }
  ...
  public void test_replace$K$V() {
    MapDefaultMethodTester.test_replace$k$V(new HashMap<>());
  }

  public void test_computeIfAbsent() {
    MapDefaultMethodTester.test_computeIfAbsent(new HashMap<>());
  }

  public void test_computeIfPresent() {
    MapDefaultMethodTester.test_computeIfPresent(new HashMap<>());
  }

  public void test_compute() {
    MapDefaultMethodTester.test_compute(new HashMap<>());
  }

  public void test_merge() {
    MapDefaultMethodTester.test_merge(new HashMap<>());
  }
}

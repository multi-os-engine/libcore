...
public class ForEachRemainingTester {
    ...
    private static <T> void test_forEachRemaining_list(List<T> collection, T[] initialData)
        throws Exception {
        collection.addAll(Arrays.asList(initialData));

        ArrayList<T> recorder = new ArrayList<>();
        collection.listIterator().forEachRemaining((T i) -> recorder.add(i));
    ...
    private static <T> void test_forEachRemaining(Collection<T> collection, T[] initialData)
            throws Exception {
        collection.addAll(Arrays.asList(initialData));
    ...
    private static <T> void test_forEachRemaining_NPE(Collection<T> collection, T[] initialData)
            throws Exception {
        try {
    ...
    private static <T> void test_forEachRemaining_CME(Collection<T> collection,
    ...
    private static <T> void test_forEachRemaining_NPE_list(Collection<T> collection,
                                                           T[] initialData)
            throws Exception {
        try {
            collection.iterator().forEachRemaining(null);
    ...
    private static <T> void test_forEachRemaining_CME_list(Collection<T> collection,
                                                      T[] initialData) throws Exception {

...
public class ForEachRemainingTester {
    ...
    public static <T> void test_forEachRemaining_CME(Collection<T> collection,
    ...
    public static <T> void test_forEachRemaining_NPE_list(Collection<T> collection,
                                                          T[] initialData) throws Exception {
        try {
            collection.iterator().forEachRemaining(null);
            fail();
    ...
    public static <T> void test_forEachRemaining_CME_list(Collection<T> collection,
                                                          T[] initialData) throws Exception {
        collection.add(initialData[0]);
        try {
            collection.iterator().forEachRemaining(i -> collection.add(i));

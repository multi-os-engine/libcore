...
public class ConcurrentHashMapTest extends junit.framework.TestCase {
  ...
  public void test_getOrDefault() {
    MapDefaultMethodTester.test_getOrDefault(new ConcurrentHashMap<>(), false);
  }
  ...
  public void test_putIfAbsent() {
    MapDefaultMethodTester.test_putIfAbsent(new ConcurrentHashMap<>());
  }

  public void test_remove() {
    MapDefaultMethodTester.test_remove(new ConcurrentHashMap<>());
  }
  ...
  public void test_computeIfAbsent() {
    MapDefaultMethodTester.test_computeIfAbsent(new ConcurrentHashMap<>(), false);
  }

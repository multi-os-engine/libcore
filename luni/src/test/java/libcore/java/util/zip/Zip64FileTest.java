...
public final class Zip64FileTest extends AbstractZipFileTest {
    ...
    public void testZip64Support_largeNumberOfEntries() throws IOException {
        final File file = createZip32File(65550, 2, false /* setEntrySize */);
        ZipFile zf = null;
        try {
            zf = new ZipFile(file);
    ...
    public void testZip64Support_totalLargerThan4G() throws IOException {
        final File file = createZip32File(5, 1073741824L, false /* setEntrySize */);
        ZipFile zf = null;
        try {
            zf = new ZipFile(file);
    ...
    public void testZip64Support_hugeEntry() throws IOException {
        // We're not setting a zip
        try {
            createZip32File(1, 4294967410L, false /* setEntrySize */);
            fail();
        } catch (IOException expected) {
        }

        final File file = createZip32File(1, 4294967410L, true /* setEntrySize */);
        ZipFile zf = null;
        try {
            zf = new ZipFile(file);
    ...
    private File createZip32File(int numEntries, long entrySize, boolean setEntrySize)
            throws IOException {

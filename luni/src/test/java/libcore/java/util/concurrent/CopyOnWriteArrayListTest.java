...
public final class CopyOnWriteArrayListTest extends TestCase {
    ...
    public void test_forEach() {
        ...
        l.forEach(k -> temp.add(k*2));
        assertEquals(20.0, temp.get(0));
        assertEquals(10.0, temp.get(1));
        assertEquals(4.0, temp.get(2));
    ...
    public void test_subList_forEach() {
        List<Double> l = new CopyOnWriteArrayList<>(new Double[]{10.0, 5.0, 2.0, -3.0, 7.0, 12.0}).subList(1, 4);
        List<Double> temp = new ArrayList<>();
        l.forEach(k -> temp.add(k * 2));
        assertEquals(10.0, temp.get(0));
        assertEquals(4.0, temp.get(1));
        assertEquals(-6.0, temp.get(2));

...
public class LinkedHashMapTest extends junit.framework.TestCase {
  ...
  public void test_getOrDefault() {
    MapDefaultMethodTester.test_getOrDefault(new LinkedHashMap<>());
  ...
  public void test_putIfAbsent() {
    MapDefaultMethodTester.test_putIfAbsent(new LinkedHashMap<>());
  ...
  public void test_remove() {
    MapDefaultMethodTester.test_remove(new LinkedHashMap<>());
  }

  public void test_replace$K$V$V() {
    MapDefaultMethodTester.test_replace$k$V$V(new LinkedHashMap<>());
  ...
  public void test_replace$K$V() {
    MapDefaultMethodTester.test_replace$k$V(new LinkedHashMap<>());
  ...
  public void test_computeIfAbsent() {
    MapDefaultMethodTester.test_computeIfAbsent(new LinkedHashMap<>());
  ...
  public void test_computeIfPresent() {
    MapDefaultMethodTester.test_computeIfPresent(new LinkedHashMap<>());
  ...
  public void test_compute() {
    MapDefaultMethodTester.test_compute(new LinkedHashMap<>());
  ...
  public void test_merge() {
    MapDefaultMethodTester.test_merge(new LinkedHashMap<>());

...
public class ConcurrentSkipListMapTest extends junit.framework.TestCase {
  ...
  public void test_getOrDefault() {
    MapDefaultMethodTester.test_getOrDefault(new ConcurrentSkipListMap<>(), false);
  }
  ...
  public void test_putIfAbsent() {
    MapDefaultMethodTester.test_putIfAbsent(new ConcurrentSkipListMap<>());
  }

  public void test_remove() {
    MapDefaultMethodTester.test_remove(new ConcurrentSkipListMap<>());
  }

  public void test_replace$K$V$V() {
    MapDefaultMethodTester.test_replace$K$V$V(new ConcurrentSkipListMap<>());
  }

  public void test_replace$K$V() {
    MapDefaultMethodTester.test_replace$K$V(new ConcurrentSkipListMap<>(), false);
  }

  public void test_computeIfAbsent() {
    MapDefaultMethodTester.test_computeIfAbsent(new ConcurrentSkipListMap<>(),false);
  }

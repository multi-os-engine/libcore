...
public class LongSummaryStatisticsTest extends junit.framework.TestCase {
    ...
    private static long data1[] = {2, -5, 7, -1, 1, 0, 100};
    private static long data2[] = {1, 3, 2, 1, 7};
    ...
    public void test_combine() {
        ...
        assertEquals(9833333, (int)(lssCombined.getAverage()*1000000));
    }
    ...
    public void test_getAverage() {
        LongSummaryStatistics lss1 = getLongSummaryStatisticsData1();
        assertEquals(14857142, (int)(lss1.getAverage()*1000000));
    }

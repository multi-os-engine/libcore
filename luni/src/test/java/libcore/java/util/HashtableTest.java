...
public class HashtableTest extends junit.framework.TestCase {
  ...
  public void test_getOrDefault() {
    MapDefaultMethodTester.test_getOrDefault(new Hashtable<>());
  ...
  public void test_replace$K$V() {
    MapDefaultMethodTester.test_replace$k$V(new Hashtable<>());
  ...
  public void test_compute() {
    MapDefaultMethodTester.test_compute(new Hashtable<>());

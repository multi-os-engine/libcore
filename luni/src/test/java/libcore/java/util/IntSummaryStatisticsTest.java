...
public class IntSummaryStatisticsTest extends junit.framework.TestCase {
    ...
    private static int data1[] = {2, -5, 7, -1, 1, 0, 100};
    private static int data2[] = {1, 3, 2, 1, 7};
    ...
    public void test_combine() {
        ...
        assertEquals(9833333, (int)(issCombined.getAverage()*1000000));
    }
    ...
    public void test_getAverage() {
        IntSummaryStatistics iss1 = getIntSummaryStatisticsData1();
        assertEquals(14857142, (int)(iss1.getAverage()*1000000));
    }

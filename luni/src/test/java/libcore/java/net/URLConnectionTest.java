...
public final class URLConnectionTest extends AbstractResourceLeakageDetectorTestCase {
    ...
    public void testContentTypeDefaulting() throws Exception {
        ...
        testContentTypeDefaulting("PUT", false, true);
        testContentTypeDefaulting("PUT", true, true);
        testContentTypeDefaulting("POST", false, true);
        testContentTypeDefaulting("POST", true, true);
        testContentTypeDefaulting("DELETE", false, true);
        testContentTypeDefaulting("DELETE", true, true);

        // GET, HEAD. OPTIONS and TRACE do not default the Content-Type. These do not permit a
        // request body.
        // checkContentTypeHeader(method, includeRequestBody, expectContentTypeDefaulting)
        testContentTypeDefaulting("GET", false, false);
        testContentTypeDefaulting("HEAD", false, false);
        testContentTypeDefaulting("OPTIONS", false, false);
        testContentTypeDefaulting("TRACE", false, false);

        // GET does not support a request body, but adding a request body to a GET turns it into a
        // POST which does.
        testContentTypeDefaulting("GET", true, true);
    }

    private void testContentTypeDefaulting(String httpMethod, boolean includeRequestBody,

...
public final class URLConnectionTest extends AbstractResourceLeakageDetectorTestCase {
    ...
    public void testSslFallback_allSupportedProtocols() throws Exception {
        ...
        assertSocket(clientSocket3, true /* expectedWasFallbackScsvSet */, "TLSv1", "SSLv3");

        TlsFallbackDisabledScsvSSLSocket clientSocket4 =
                (TlsFallbackDisabledScsvSSLSocket) createdSockets.get(3);
        assertSocket(clientSocket4, true /* expectedWasFallbackScsvSet */, "SSLv3");
    }
    ...
    public void testSslFallback_defaultProtocols() throws Exception {
        ...
        TlsFallbackDisabledScsvSSLSocket clientSocket2 =
                (TlsFallbackDisabledScsvSSLSocket) createdSockets.get(1);
        assertSocket(clientSocket2, true /* expectedWasFallbackScsvSet */, "TLSv1.1", "TLSv1");

        TlsFallbackDisabledScsvSSLSocket clientSocket3 =
                (TlsFallbackDisabledScsvSSLSocket) createdSockets.get(2);
        assertSocket(clientSocket3, true /* expectedWasFallbackScsvSet */, "TLSv1");
    }

    private static void assertSocket(TlsFallbackDisabledScsvSSLSocket socket,
            boolean expectedWasFallbackScsvSet, String... expectedProtocols) {
        List<String> clientSocket2EnabledProtocols = Arrays.asList(
                socket.getEnabledProtocols());
        assertContainsAll(clientSocket2EnabledProtocols, expectedProtocols);
    ...
    private static void assertContainsAll(List<String> actual, String... expectedValues) {
    ...
    private static void assertContains(List<String> list, String value) {
        ...
        fail(list.toString() + " does not contain " + value);
    }

    private static void assertContainsNoneMatching(List<String> list, String pattern) {

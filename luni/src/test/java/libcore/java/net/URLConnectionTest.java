...
public final class URLConnectionTest extends TestCase {
    ...
    /**
     * A {@link Platform} that doesn't support two methods used by OkHttp 2.7.5 in
     * the course of providing CertificatePinning. Android implements certificate
     * pinning differently so we deliberately don't expose any API surface that
     * would interact with OkHttp's implementation. The below Platform implementation
     * lets tests sanity check that these methods are not invoked / involved insome
     * sample uses of the APIs exposed in Android.
     */

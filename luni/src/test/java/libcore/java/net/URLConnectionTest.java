...
public final class URLConnectionTest extends TestCase {
     ...
     * exclusively used in relation to certificate pinning. Android only provides the
     * minimal implementation of these methods to get OkHttp's tests to pass, so they
     * should never be invoked outside of OkHttp's tests.
     */

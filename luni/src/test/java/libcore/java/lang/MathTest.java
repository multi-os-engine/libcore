...
public class MathTest extends TestCase {
    ...
    private void testIncrementExactI(int a) {
        try {
            assertEquals(a + 1L, Math.incrementExact(a));
        } catch (ArithmeticException e) {
            long result = (long) a + 1L;
            if (result == a + 1) {
                fail(); // This is not an overflow
            }
        }
    ...
    private void testDecrementExactI(int a) {
        try {
            assertEquals(a - 1L, Math.decrementExact(a));
        } catch (ArithmeticException e) {
            long result = (long) a - 1L;
            if (result == a - 1) {
                fail(); // This is not an overflow
    ...
    private void testAddExactL(long a, long b) {
        try {
            ...
            if (result.equals(BigInteger.valueOf(a + b))) {
                fail(); // This is not an overflow
            }
        }
    }
    ...
    private void testIncrementExactL(long a) {
        try {
            ...
            BigInteger result = BigInteger.valueOf(a).add(BigInteger.ONE);
            if (result.equals(BigInteger.valueOf(a + 1L))) {
                fail(); // This is not an overflow
            }
        }
    }
    ...
    private void testDecrementExactL(long a) {
        try {
            ...
            BigInteger result = BigInteger.valueOf(a).subtract(BigInteger.ONE);
            if (result.equals(BigInteger.valueOf(a - 1L))) {
                fail(); // This is not an overflow
            }
        }
    ...
    private void testNegateExactL(long a) {
        try {
            ...
            BigInteger result = BigInteger.valueOf(a).negate();
            if (result.equals(BigInteger.valueOf(-a))) {
                fail(); // This is not an overflow
            }
        }
    }

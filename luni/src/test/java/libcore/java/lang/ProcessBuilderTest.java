...
public class ProcessBuilderTest extends AbstractResourceLeakageDetectorTestCase {
    ...
    /**
     * Checks that INHERIT and PIPE use the identity hashCode. This is not guaranteed
     * by javadoc (so we may change it), but ensures that these don't commonly have
     * hash collisions.
     */
    public void testRedirect_identityHashCode() {

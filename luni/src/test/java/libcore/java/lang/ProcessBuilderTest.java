...
public class ProcessBuilderTest extends AbstractResourceLeakageDetectorTestCase {
    ...
    /**
     * Tests input, output and error redirection from/to files.
     * This checks that "base64 -d" on input that starts validly, but has
    ...
    /**
     * Tests input, output and error redirection from/to PIPE.

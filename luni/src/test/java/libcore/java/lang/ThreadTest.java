...
public final class ThreadTest extends TestCase {
    ...
    public void testParkUntilWithOverflowValue() throws Exception {
        ...
        // System.currentTimeMillis() + Long.MAX_VALUE / NANOS_PER_MILLI is largest available
        // argument for parkUntil. Larger value will overflow when converted to nanoseconds,
        // should return immediately.
        current.parkUntil$(System.currentTimeMillis() + (1 + Long.MAX_VALUE / 1000000));

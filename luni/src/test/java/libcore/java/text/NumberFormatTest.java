...
public class NumberFormatTest extends junit.framework.TestCase {
    ...
    public void test_getIntegerInstance_ar() throws Exception {
        // Note that the pattern is either '<positive_format>;<negative_format>' or just the
        // positive part with no semicolon.
    ...
    public void test_setCurrency() throws Exception {
        ...
        // The Armenian Dram is a special case where the fractional digits are usually 0.

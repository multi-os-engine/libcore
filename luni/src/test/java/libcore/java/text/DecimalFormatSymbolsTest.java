...
public class DecimalFormatSymbolsTest extends junit.framework.TestCase {
    ...
    private static class DFSProxy extends DecimalFormatSymbols {
        public DFSProxy(Locale locale) {
            super(locale);
        }
    ...
    public void compareDfs(DecimalFormatSymbols dfs,
        ...
        // Check currency code is the same because ICU returns it's own currency class.
    ...
    public void testToIcuDecimalFormatSymbols() {
        DFSProxy dfs = new DFSProxy(Locale.US);
    ...
    public void testFromIcuDecimalFormatSymbols() {
        ...
        DecimalFormatSymbols dfs = DFSProxy.fromIcuInstance(icuSymb);
        compareDfs(dfs, icuSymb);
    }

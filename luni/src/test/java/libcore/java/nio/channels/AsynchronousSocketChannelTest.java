...
public class AsynchronousSocketChannelTest extends junit.framework.TestCase {
    final int MESSAGE_SIZE = 32; // Comfortably smaller than the default TCP socket buffer size
                                 // to avoid blocking on write.
    ...
    private void test_futureReadWrite(boolean useDirectByteBuffer) throws Exception {
        ...
        // Accept & write data
        final ByteBuffer sendData = createTestByteBuffer(MESSAGE_SIZE, useDirectByteBuffer);
        Socket sss = ss.accept();
        // Small message, won't block on write
        sss.getOutputStream().write(sendData.array(), sendData.arrayOffset(), MESSAGE_SIZE);

        // Read data from async channel and call #get on result future
        ByteBuffer receivedData = createTestByteBuffer(MESSAGE_SIZE, useDirectByteBuffer);
        assertEquals(MESSAGE_SIZE, (int)asc.read(receivedData).get(1000, TimeUnit.MILLISECONDS));
        ...
        assertEquals(MESSAGE_SIZE, (int)asc.write(sendData).get(1000, TimeUnit.MILLISECONDS));

        // Read data and compare with original
        byte[] readArray = new byte[MESSAGE_SIZE];
        assertEquals(MESSAGE_SIZE, sss.getInputStream().read(readArray));
    ...
    private void test_completionHandlerReadWrite(boolean useDirectByteBuffer) throws Throwable {
        ...
        // Accept & write data
        ByteBuffer sendData = createTestByteBuffer(MESSAGE_SIZE, useDirectByteBuffer);
        Socket sss = ss.accept();
        // Small message, won't block on write
        sss.getOutputStream().write(sendData.array(), sendData.arrayOffset(), MESSAGE_SIZE);
        ...
        assertEquals(MESSAGE_SIZE, (int)readCompletionHandler.get(1000));
        ...
        assertEquals(MESSAGE_SIZE, (int)writeCompletionHandler.get(1000));
    ...
    private void test_scatterReadWrite(boolean useDirectByteBuffer) throws Throwable {
        ...
        // Accept & write data
        ByteBuffer sendData1 = createTestByteBuffer(MESSAGE_SIZE, useDirectByteBuffer, 0);
        ByteBuffer sendData2 = createTestByteBuffer(MESSAGE_SIZE, useDirectByteBuffer, 6);
        Socket sss = ss.accept();

        // Small message, won't block on write
        sss.getOutputStream().write(sendData1.array(), sendData1.arrayOffset(), MESSAGE_SIZE);
        sss.getOutputStream().write(sendData2.array(), sendData2.arrayOffset(), MESSAGE_SIZE);

        // Read data from async channel
        ByteBuffer receivedData1 = createTestByteBuffer(MESSAGE_SIZE, useDirectByteBuffer);
        ByteBuffer receivedData2 = createTestByteBuffer(MESSAGE_SIZE, useDirectByteBuffer);
        ...
        assertEquals(MESSAGE_SIZE * 2L, (long)readCompletionHandler.get(1000));
        assertEquals(attachment, readCompletionHandler.getAttachment());
        ...
        assertEquals(MESSAGE_SIZE*2L, (long)writeCompletionHandler.get(1000));
        assertEquals(attachment, writeCompletionHandler.getAttachment());
    ...
    public void test_shutdown() throws Exception {
        ...
        // Accept & write data
        ByteBuffer sendData = createTestByteBuffer(MESSAGE_SIZE, false);
        Socket sss = ss.accept();
        // Small message, won't block on write
        ...
        asc.shutdownInput();
        ByteBuffer receivedData = createTestByteBuffer(MESSAGE_SIZE, false);

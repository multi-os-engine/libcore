...
public class DatagramChannelMulticastTest extends TestCase {
  ...
  private final static InetAddress GOOD_MULTICAST_IPv4 = lookup("239.255.0.1");
  private final static InetAddress BAD_MULTICAST_IPv4 = lookup("239.255.0.2");
  private final static InetAddress GOOD_MULTICAST_IPv6 = lookup("ff05::7:7");
  private final static InetAddress BAD_MULTICAST_IPv6 = lookup("ff05::7:8");
  ...
  // filters.
  private final static InetAddress UNICAST_IPv4_1 = lookup("192.168.1.1");
  private final static InetAddress UNICAST_IPv4_2 = lookup("192.168.1.2");
  private final static InetAddress UNICAST_IPv6_1 = lookup("2001:db8::1");
  private final static InetAddress UNICAST_IPv6_2 = lookup("2001:db8::2");
  ...
  private void test_joinAnySource(InetAddress group, InetAddress group2) throws Exception {
    ...
    // now verify that we didn't received the second message

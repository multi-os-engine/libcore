...
public final class BigDecimalTest extends TestCase {
    ...
    public void testMultiply_near64BitOverflow_positive_scaled() {
    ...
    public void testMultiply_near64BitOverflow_positive() {
        ...
        assertEquals("9223372036854775808", multiply(Long.MIN_VALUE, -1).toString());
        assertEquals("9223372036854775808", multiply(Long.MIN_VALUE / 2, -2).toString());
        assertEquals("9223372036854775808", multiply(-(Long.MIN_VALUE / 2), 2).toString());
        assertEquals("9223372036854775808", multiply(1L << 31, 1L << 32).toString());
        assertEquals("9223372036854775808", multiply(-(1L << 31), -(1L << 32)).toString());

        // Results near but not exactly +2^63
        assertEquals("9223372036854775806", multiply(2147483647, 4294967298L).toString());
        assertEquals("9223372036854775807", multiply(Long.MAX_VALUE, 1).toString());
        assertEquals("9223372036854775807", multiply(42128471623L, 218934409L).toString());
        assertEquals("9223372036854775809", multiply(77158673929L, 119537721L).toString());
        assertEquals("9223372036854775810", multiply((1L << 62L) + 1, 2).toString());
    }
    ...
    public void testMultiply_near64BitOverflow_negative() {
        ...
        assertEquals("-9223372036854775808", multiply(-(1L << 31), 1L << 32).toString());
        assertEquals("-9223372036854775807", multiply(-42128471623L, 218934409L).toString());
        assertEquals("-9223372036854775810", multiply(-(Long.MIN_VALUE / 2) + 1, -2).toString());
    }

    private static BigDecimal multiply(long a, long b) {

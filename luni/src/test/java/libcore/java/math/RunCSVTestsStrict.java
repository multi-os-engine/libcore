...
public class RunCSVTestsStrict extends junit.framework.TestCase {
    ...
    public void test_CSV_inputs() {
        ...
        for (String csvFileName : csvFileNames) {
            ...
            try {
                System.out.println(getClass().getResourceAsStream(csvFileName));
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    runTest(testCase);
                    totalTests++;
                    // System.out.println("Completed runing test: " +
                    // totalTests);
                }

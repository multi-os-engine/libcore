...
public final class DefaultHostnameVerifierTest extends TestCase {
    ...
    public void testWildcardMatchesWildcardSuffix() {
        assertTrue(verifyWithHostnamePattern("b.c.d", "*.b.c.d"));
        assertTrue(verifyWithHostnamePattern("imap.google.com", "*.imap.google.com"));
    }

    public void testWildcardMatchingSubstring() {
        assertTrue(verifyWithHostnamePattern("b.c.d", "b*.c.d"));
        assertTrue(verifyWithHostnamePattern("imap.google.com", "ima*.google.com"));
    }
    ...
    public void testWildcardMatchesChildDomain() {
        assertFalse(verifyWithHostnamePattern("a.b.c.d", "*.c.d"));
    }

    public void testWildcardsRejectedForSingleLabelPatterns() {
        assertFalse(verifyWithHostnamePattern("d", "*"));
        assertFalse(verifyWithHostnamePattern("d.", "*."));
        assertFalse(verifyWithHostnamePattern("d", "d*"));
        assertFalse(verifyWithHostnamePattern("d.", "d*."));
        assertFalse(verifyWithHostnamePattern("d", "*d"));
        assertFalse(verifyWithHostnamePattern("d.", "*d."));
        assertFalse(verifyWithHostnamePattern("ddd", "d*d"));
        assertFalse(verifyWithHostnamePattern("ddd.", "d*d."));
    }

    public void testVerifyHostName() {
        assertTrue(verifyWithHostnamePattern("a.b.c.d", "a.b.c.d"));
        assertTrue(verifyWithHostnamePattern("a.b.c.d", "*.b.c.d"));
        assertFalse(verifyWithHostnamePattern("a.b.c.d", "*.*.c.d"));
        assertTrue(verifyWithHostnamePattern("imap.google.com", "imap.google.com"));
        assertFalse(verifyWithHostnamePattern("imap2.google.com", "imap.google.com"));
        assertTrue(verifyWithHostnamePattern("imap.google.com", "*.google.com"));
        assertTrue(verifyWithHostnamePattern("imap2.google.com", "*.google.com"));
        assertFalse(verifyWithHostnamePattern("imap.google.com", "*.googl.com"));
        assertFalse(verifyWithHostnamePattern("imap2.google2.com", "*.google3.com"));
        assertFalse(verifyWithHostnamePattern("imap.google.com", "a*.google.com"));
        assertFalse(verifyWithHostnamePattern("imap.google.com", "ix*.google.com"));
        assertTrue(verifyWithHostnamePattern("imap.google.com", "iMap.Google.Com"));
        assertTrue(verifyWithHostnamePattern("weird", "weird"));
        assertFalse(verifyWithHostnamePattern("weird", "weird."));
     ...
     * certificate.
     */
    private boolean verifyWithHostnamePattern(String hostname, String pattern) {

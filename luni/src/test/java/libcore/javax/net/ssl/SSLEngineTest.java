...
public class SSLEngineTest extends TestCase {
    ...
    public void test_SSLEngine_getSupportedCipherSuitesReturnsCopies() throws Exception {
    ...
    public void test_SSLEngine_getEnabledCipherSuitesReturnsCopies() throws Exception {
        TestSSLContext c = TestSSLContext.create();
        SSLEngine e = c.clientContext.createSSLEngine();
    ...
    public void test_SSLEngine_getSupportedProtocolsReturnsCopies() throws Exception {
        TestSSLContext c = TestSSLContext.create();
        SSLEngine e = c.clientContext.createSSLEngine();
    ...
    public void test_SSLEngine_getEnabledProtocolsReturnsCopies() throws Exception {
        TestSSLContext c = TestSSLContext.create();
        SSLEngine e = c.clientContext.createSSLEngine();

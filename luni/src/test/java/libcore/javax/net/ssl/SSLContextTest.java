...
public class SSLContextTest extends TestCase {
    ...
    public void test_SSLContext_init_correctProtocolVersionsEnabled() throws Exception {
        for (String tlsVersion : StandardNames.SSL_CONTEXT_PROTOCOLS) {
            ...
            StandardNames.assertTlsVersions(tlsVersion, ((SSLSocket) (context.getSocketFactory()
                    .createSocket())).getEnabledProtocols());
            StandardNames.assertTlsVersions(tlsVersion, ((SSLServerSocket) (context
                    .getServerSocketFactory().createServerSocket())).getEnabledProtocols());
            StandardNames.assertTlsVersions(tlsVersion, context.getDefaultSSLParameters()
                    .getProtocols());
            StandardNames.assertTlsVersions(tlsVersion, context.createSSLEngine()
                    .getEnabledProtocols());
        }
    }

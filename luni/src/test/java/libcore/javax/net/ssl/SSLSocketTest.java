...
public class SSLSocketTest extends TestCase {
    ...
    public void test_SSLSocket_ClientHello_cipherSuites() throws Exception {
        ForEachRunner.run(new ForEachRunner.Callback<Pair<String, SSLSocketFactory>>() {
            @Override
            public void run(Pair<String, SSLSocketFactory> namedFactory) throws Exception {
                SSLSocketFactory sslSocketFactory = namedFactory.getSecond();

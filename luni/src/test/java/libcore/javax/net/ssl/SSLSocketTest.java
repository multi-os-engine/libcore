...
import tests.util.ForEachRunnable;
...
public class SSLSocketTest extends TestCase {
    ...
    public void test_SSLSocket_ClientHello_cipherSuites() throws Exception {
        new ForEachRunnable<SSLSocketFactory>() {
            @Override
            protected void run(SSLSocketFactory sslSocketFactory) throws Exception {
        ...
        }.runAllNamed(getSSLSocketFactoriesToTest());
    }

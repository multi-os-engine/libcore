...
public class XmlPullParserFactoryTest extends TestCase {
    ...
    public void testOverriding_customClassList() throws Exception {
        TestXmlPullParserFactory tf = new TestXmlPullParserFactory(
                new String[] { "libcore.xml.XmlPullParserFactoryTest$XmlPullParserAdapter" },
                new String[] { "libcore.xml.XmlPullParserFactoryTest$XmlSerializerAdapter" });

        assertTrue(tf.newPullParser() instanceof XmlPullParserAdapter);
        assertTrue(tf.newSerializer() instanceof XmlSerializerAdapter);
        ...
        tf = new TestXmlPullParserFactory(
                new String[] {
                        ...
                        "libcore.xml.XmlPullParserFactoryTest$XmlPullParserAdapter" },
                new String[] {
                        "libcore.xml.XmlPullParserFactoryTest$InaccessibleXmlSerializer",
                        "libcore.xml.XmlPullParserFactoryTest$XmlSerializerAdapter" });
    ...
    public static final class XmlParserThatHatesAllFeatures extends XmlPullParserAdapter {
        @Override
    ...
    static final class InaccessibleXmlSerializer extends XmlSerializerAdapter {
    }

    static final class InaccessibleXmlParser extends XmlPullParserAdapter {
    }

    public static class XmlSerializerAdapter implements XmlSerializer {
    ...
    public static class XmlPullParserAdapter implements XmlPullParser {

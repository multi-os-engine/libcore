...
public class ClassPathURLStreamHandlerTest extends TestCase {
    ...
    public void testGetEntryOrNull() throws Exception {
        ...
        // The URL should be normalized to the "correct" name (including the "/").
        assertEquals(urlWithoutSlash, urlWithSlash);
        assertTrue(urlWithSlash.toString().endsWith("/"));
    ...
    public void testIsEntryStored() throws IOException {
        ...
        assertFalse(streamHandler.isEntryStored(DIR_ENTRY_WITH_SLASH));
    }

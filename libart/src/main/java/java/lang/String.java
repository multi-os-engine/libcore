...
public final class String implements Serializable, Comparable<String>, CharSequence {
    ...
    public byte[] getBytes(Charset charset) {
        // TODO: Remove this copy of the character array later.
        char[] value = toCharArray();
        String canonicalCharsetName = charset.name();
        if (canonicalCharsetName.equals("UTF-8")) {
            return Charsets.toUtf8Bytes(value, 0, count);
        } else if (canonicalCharsetName.equals("ISO-8859-1")) {
            return Charsets.toIsoLatin1Bytes(value, 0, count);
        } else if (canonicalCharsetName.equals("US-ASCII")) {
            return Charsets.toAsciiBytes(value, 0, count);
        } else if (canonicalCharsetName.equals("UTF-16BE")) {
            return Charsets.toBigEndianUtf16Bytes(value, 0, count);
        } else {
            CharBuffer chars = CharBuffer.wrap(value, 0, count);
    ...
    private int lastIndexOfSupplementary(int c, int start) {
        ...
        char[] chars = Character.toChars(c);
        String needle = StringFactory.newStringFromCharsNoCheck(0, chars.length, chars);
    ...
    public String replace(char oldChar, char newChar) {
        ...
        return copied ? StringFactory.newStringFromCharsNoCheck(0, _count, buffer) : this;
    }
    ...
    public String substring(int start) {
        ...
        if (start >= 0 && start <= count) {
            // TODO: StringFactory.newStringFromString?
    ...
    public String toLowerCase() {
        // TODO: Remove this copy of the character array later.
        char[] value = toCharArray();
        return CaseMapper.toLowerCase(Locale.getDefault(), this, value, 0, count);
    }
    ...
    public String toLowerCase(Locale locale) {
        // TODO: Remove this copy of the character array later.
        char[] value = toCharArray();
        return CaseMapper.toLowerCase(locale, this, value, 0, count);
    }
    ...
    public String toUpperCase() {
        // TODO: Remove this copy of the character array later.
        char[] value = toCharArray();
        return CaseMapper.toUpperCase(Locale.getDefault(), this, value, 0, count);
    }
    ...
    public String toUpperCase(Locale locale) {
        // TODO: Remove this copy of the character array later.
        char[] value = toCharArray();
        return CaseMapper.toUpperCase(locale, this, value, 0, count);
    }
    ...
    public static String valueOf(char value) {
        String s;
        if (value < 128) {
            s = StringFactory.newStringFromCharsNoCheck(value, 1, ASCII);
        } else {
            s = StringFactory.newStringFromCharsNoCheck(0, 1, new char[] { value });
        }
        s.hashCode = value;
        return s;
    }
    ...
    public boolean contentEquals(StringBuffer strbuf) {
        synchronized (strbuf) {
            ...
            String s = StringFactory.newStringFromCharsNoCheck(0, size, strbuf.getValue());
        ...
        outer_loop: for (int i = needleLengthMinus1; i < haystackLength;) {
            if (lastChar == haystackString.charAt(i)) {
                for (int j = 0; j < needleLengthMinus1; ++j) {
                    if (needleString.charAt(j) != haystackString.charAt(i + j - needleLengthMinus1)) {
                        int skip = 1;

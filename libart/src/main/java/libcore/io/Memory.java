...
public final class Memory {
    ...
    public static native int unsafePeekInt(byte[] src, int offset, boolean needsSwap);
    public static native long unsafePeekLong(byte[] src, int offset, boolean needsSwap);
    public static native short unsafePeekShort(byte[] src, int offset, boolean needsSwap);

    public static native void unsafePokeInt(byte[] src, int offset, int value, boolean needsSwap);
    public static native void unsafePokeLong(byte[] src, int offset, long value, boolean needsSwap);
    public static native void unsafePokeShort(byte[] src, int offset, short value, boolean needsSwap);

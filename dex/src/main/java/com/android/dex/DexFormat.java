...
public final class DexFormat {
    ...
    /**
     * A fake dex file version for the never completed dex file version 036.
     * This version was supported in some versions of Dalvik but was never fully supported or
     * completed and is not considered a valid dex file format.
     */
    private static final String FAKE_VERSION_FOR_DALVIK_14 = "036";
    ...
    public static int magicToApi(byte[] magic) {
        ...
        if (version.equals(VERSION_CURRENT)) {
            return API_CURRENT;
                ...
                version.equals(FAKE_VERSION_FOR_DALVIK_14)) {

...
LOCAL_STATIC_JAVA_LIBRARIES := core-tests-support sqlite-jdbc mockftpserver mockwebserver nist-pkix-tests slf4j-jdk14
LOCAL_JAVACFLAGS := $(local_javac_flags)
...
ifeq ($(LIBCORE_SKIP_TESTS),)
    ...
    LOCAL_STATIC_JAVA_LIBRARIES := sqlite-jdbc-host mockftpserver-host mockwebserver-host nist-pkix-tests-host slf4j-jdk14-host
    LOCAL_JAVACFLAGS := $(local_javac_flags)
    LOCAL_MODULE_TAGS := optional

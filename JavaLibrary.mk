...
LOCAL_STATIC_JAVA_LIBRARIES := sqlite-jdbc mockwebserver nist-pkix-tests junit4-target
LOCAL_JAVACFLAGS := $(local_javac_flags)
...
ifeq ($(WITH_HOST_DALVIK),true)
    ...
    LOCAL_STATIC_JAVA_LIBRARIES := sqlite-jdbc-host mockwebserver-host nist-pkix-tests-host junit
    LOCAL_JAVACFLAGS := $(local_javac_flags)
    LOCAL_MODULE_TAGS := optional
